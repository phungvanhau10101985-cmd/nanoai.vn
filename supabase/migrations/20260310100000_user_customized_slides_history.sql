...
create index idx_user_customized_slides_history_user_curriculum on user_customized_slides_history(user_id, curriculum_id);
create index idx_user_customized_slides_history_created on user_customized_slides_history(created_at desc);
