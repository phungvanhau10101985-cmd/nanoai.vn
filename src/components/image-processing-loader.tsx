...
export type ProcessingMode = 'restore' | 'sharpen' | 'beautify' | 'merge' | 'tryon' | 'banner' | 'idcard' | 'logo' | 'cheanh' | 'eraser' | 'product' | 'headshot' | 'outpaint' | 'faceswap' | 'mockup3d' | 'model3d' | 'interior' | 'story' | 'sticker' | 'seal' | 'text2img'
...
const modeConfig = {
  ...
  text2img: {
    ...
    gradient: 'from-violet-100/80 via-purple-50/60 to-violet-100/80',
    accent: 'text-violet-700',
    steps: ['Phân tích mô tả', 'Áp dụng ảnh tham khảo (nếu có)', 'Tạo ảnh', 'Hoàn thiện'],
  },
}
