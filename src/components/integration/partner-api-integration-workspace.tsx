...
type Partner = { id: string; display_name: string | null; slug: string }
...
export function PartnerApiIntegrationWorkspace({
  ...
  return (
    <>
      ...
      />
      {betweenKeysAndGuide}
      <PartnerDevIntegrationGuide baseUrl={baseUrl} t={tGuide} partners={partners} selectedPartnerId={partnerId} />
    </>
  )
}
