...
export function FeatureSeoSection({ seo }: FeatureSeoSectionProps) {
  ...
  const relatedTools = [
    ...
    { href: '/tao-thiep-moi-cuoi-ai', label: tr('Tạo thiệp cưới AI', 'AI wedding invitation', 'AI 婚礼请柬', 'AI結婚式招待状', 'AI 청첩장') },
    { href: '/thiet-ke-bao-bi', label: tr('Thiết kế hộp giấy', 'Paper box design', '纸盒设计', '紙箱デザイン', '종이 상자 디자인') },
    { href: '/tao-nhan-gioi-thieu-san-pham', label: tr('Nhãn sản phẩm', 'Product label', '产品标签', '製品ラベル', '제품 라벨') },
    { href: '/tao-ma-vach', label: tr('Mã vạch & QR', 'Barcode & QR', '条码和二维码', 'バーコードとQR', '바코드 & QR') },
