    ...
    items: [
      {
        ...
        description: {
          vi: 'Số tài khoản, QR SePay, và Secret Key HMAC webhook (whsec_).',
          en: 'Bank account, SePay QR, and HMAC webhook Secret Key (whsec_).',
          zh: '银行账户、SePay 二维码，以及 HMAC webhook Secret Key（whsec_）。',
          ja: '銀行口座・SePay QR・HMAC webhook Secret Key（whsec_）。',
          ko: '은행 계좌, SePay QR, HMAC 웹훅 Secret Key(whsec_).',
        },
        icon: Landmark,
      },
      {
