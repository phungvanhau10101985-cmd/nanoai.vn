...
export const PACKAGING_KIT_FLOW: StudioFlowStepDef[] = [
  ...
  { key: 'box_mockup_3d', labelKey: 'box_mockup_3d', phase: 'design', generator: 'packaging', aspectRatio: '1:1', formFactor: 'square' },
  ...
  { key: 'barcode_label', labelKey: 'barcode_label', phase: 'design', generator: 'banner', aspectRatio: '1:1', formFactor: 'square' },
]
...
export function getFlowStep(presetId: string, stepKey: string): StudioFlowStepDef | undefined {
  return getFlowSteps(presetId).find((s) => s.key === stepKey)
}
