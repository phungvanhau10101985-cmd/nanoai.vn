...
const STEP_KEY_ALIASES: Record<string, string[]> = {
  ...
  portrait_social_ads: ['feed doc', 'feed dọc', 'portrait feed', '4:5', '1080x1350'],
  vertical_story_ads: [
    'facebook story',
    'fb story',
    'instagram reels',
  ...
  web_leaderboard: ['leaderboard', 'banner ngang manh', '4:1'],
  wide_hero_desktop: ['hero desktop', '21:9', 'sieu rong', 'siêu rộng'],
  ...
  design_sector: ['mang thiet ke', 'mảng thiết kế', 'design sector', 'nganh', 'ngành'],
  design_format: ['dinh dang', 'định dạng', 'output format', 'design format'],
  render_style: ['phong cach render', 'render style', 'style render'],
  sample_upload: ['anh mau', 'ảnh mẫu', 'sample photo', 'sample upload'],
  design_notes: ['ghi chu', 'ghi chú', 'design notes', 'extra notes'],
  concept_sheet: ['concept sheet', 'bang concept', 'bảng concept', 'concept board'],
  detail_panel: ['chi tiet', 'chi tiết', 'detail panel', 'close up'],
  technical_flat: ['ban ve ky thuat', 'bản vẽ kỹ thuật', 'technical flat', 'flat sketch'],
