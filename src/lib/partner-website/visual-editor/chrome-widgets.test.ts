...
test('footer add kinds stay in-flow links, never float or head kit', () => {
  ...
  assert.ok(FOOTER_ADD_CHROME_KINDS.includes('how-to-buy'))
  assert.ok(FOOTER_ADD_CHROME_KINDS.includes('brand-origin'))
  assert.ok(FOOTER_ADD_CHROME_KINDS.includes('reviews-policy'))
  assert.ok(FOOTER_ADD_CHROME_KINDS.includes('trust'))
  assert.ok(FOOTER_ADD_CHROME_KINDS.includes('company'))
