...
import { PARTNER_SHOP_CHROME_KIT_CSS, PW_TOPBAR_EDGE_SHIFT_CSS } from '@/lib/partner-website/shop/partner-site-chrome-kit'
import { injectPartnerShopFontsIntoHtml } from '@/lib/partner-website/shop/inject-partner-shop-fonts'
import { scopeMarketplaceLookCss } from '@/lib/partner-website/shop/marketplace-shop-look-css'
...
import { PARTNER_MARKETING_BANNER_LIVE_CSS } from '@/lib/partner-website/shop/build-partner-marketing-banner-bootstrap-script'
import {
  PW_CHROME_BTN_MIN_H,
  PW_CHROME_H_VAR,
...
import { PW_SHOP_TAP_ACK_CSS } from '@/lib/partner-website/shop/partner-site-tap-ack'
import {
  PARTNER_SHOP_LOGO_HOST_SCRIPT,
  PARTNER_SHOP_LOGO_HOST_SCRIPT_ID,
} from '@/lib/partner-website/shop/partner-shop-logo-host-script'

export { PARTNER_SHOP_LOGO_HOST_SCRIPT, PARTNER_SHOP_LOGO_HOST_SCRIPT_ID }
...
html .pw-shop-footer-bar p,html .pw-footer-bar p,html .pw-footer-bottom p{
  color:inherit!important
}
html .pw-footer-col a:hover,html .pw-shop-footer-col a:hover{color:var(--pw-primary)!important}
...
[data-pw-inline-visual-root][data-pw-edit-device="tablet"] .pw-footer-grid,[data-pw-inline-visual-root][data-pw-edit-device="tablet"] .pw-shop-footer-inner{grid-template-columns:repeat(2,minmax(0,1fr))!important}
...
[data-pw-inline-visual-root][data-pw-active-device="laptop"] .pw-footer-grid,[data-pw-inline-visual-root][data-pw-active-device="laptop"] .pw-shop-footer-inner,
...
.pw-header-main,.pw-shop-header-inner{display:flex!important;align-items:center!important;column-gap:6px!important;width:100%!important;max-width:none!important;margin-left:0!important;margin-right:0!important;padding:8px 10px!important;padding-left:8px!important;padding-right:10px!important}
...
.pw-header-actions > *,.pw-shop-header-actions > *{order:0!important}
...
.pw-header-main,.pw-shop-header-inner{column-gap:10px!important;padding:10px 16px!important;width:100%!important;max-width:none!important;margin-left:0!important;margin-right:0!important}
...
.pw-header-search,.pw-shop-search-wrap{min-width:180px!important;min-height:${PW_SEARCH_FORM_HEIGHT.tablet}px!important}
.pw-search-form,.pw-shop-search-form{height:${PW_SEARCH_FORM_HEIGHT.tablet}px!important}
.pw-header-actions,.pw-shop-header-actions{gap:var(--pw-kit-gap, ${PW_HEAD_KIT_GAP.tablet}px)!important;overflow:visible!important;max-width:40%!important}
.pw-header-actions [data-pw-chrome-btn],.pw-shop-header-actions [data-pw-chrome-btn]{--pw-chrome-size:${PW_HEAD_ICON_SIZE.tablet}px;min-width:40px!important;min-height:40px!important}
.pw-search-submit .pw-shop-search-submit-label,.pw-shop-search-submit .pw-shop-search-submit-label{display:none!important;font-size:0!important}
`.trim()
...
.pw-header a.pw-brand>img.pw-logo,.pw-header a.pw-shop-brand>img.pw-shop-logo,.pw-header a[data-pw-logo-home]>img.pw-logo,.pw-shop-header a.pw-brand>img.pw-logo,.pw-shop-header a.pw-shop-brand>img.pw-shop-logo,.pw-shop-header a[data-pw-logo-home]>img.pw-shop-logo{height:36px!important;width:auto!important;max-height:none!important}
.pw-header .pw-logo-frame,.pw-header [data-pw-logo-frame="1"],.pw-shop-header .pw-logo-frame,.pw-shop-header [data-pw-logo-frame="1"]{width:var(--pw-logo-box-w,140px)!important;height:var(--pw-logo-box-h,36px)!important}
...
.pw-topbar-inner,.pw-shop-topbar-inner{padding:4px var(--pw-chrome-inset,60px)!important;${PW_TOPBAR_EDGE_SHIFT_CSS};gap:var(--pw-kit-gap, 18px)!important}
...
export const PARTNER_SHOP_WIDE_HEADER_BALANCE_CSS = [
  ...
  pwHostPrefixCss(
    PW_SCENE_DESKTOP_HOSTS,
    `.pw-header-main,.pw-shop-header-inner{gap:8px!important;padding:8px var(--pw-chrome-inset,60px)!important}.pw-header-actions [data-pw-chrome-btn]:not([data-pw-chrome-size]),.pw-shop-header-actions [data-pw-chrome-btn]:not([data-pw-chrome-size]){--pw-chrome-size:${PW_HEAD_ICON_SIZE.desktop}px!important;--pw-chrome-w:${PW_HEAD_ICON_SIZE.desktop}px!important;--pw-chrome-h:${PW_HEAD_ICON_SIZE.desktop}px!important}.pw-cat-btn:not([data-pw-chrome-added]) svg,.pw-shop-cat-btn:not([data-pw-chrome-added]) svg,[data-pw-el="cat-toggle"]:not([data-pw-chrome-added]) svg,.pw-chrome-cat-wrap svg{width:${PW_HEAD_ICON_SIZE.desktop}px!important;height:${PW_HEAD_ICON_SIZE.desktop}px!important;max-width:${PW_HEAD_ICON_SIZE.desktop}px!important;max-height:${PW_HEAD_ICON_SIZE.desktop}px!important}`
  ),
  pwHostPrefixCss(
    PW_SCENE_LAPTOP_HOSTS,
    `.pw-header-main,.pw-shop-header-inner{gap:6px!important;padding:6px var(--pw-chrome-inset,60px)!important}.pw-header-actions,.pw-shop-header-actions{gap:var(--pw-kit-gap, ${PW_HEAD_KIT_GAP.laptop}px)!important}.pw-header-actions [data-pw-chrome-kit="1"],.pw-shop-header-actions [data-pw-chrome-kit="1"],.pw-header-actions [data-pw-chrome-btn],.pw-shop-header-actions [data-pw-chrome-btn]{--pw-chrome-size:${PW_HEAD_ICON_SIZE.laptop}px}.pw-header-actions [data-pw-chrome-btn]:not([data-pw-chrome-size]),.pw-shop-header-actions [data-pw-chrome-btn]:not([data-pw-chrome-size]){--pw-chrome-size:${PW_HEAD_ICON_SIZE.laptop}px!important;--pw-chrome-w:${PW_HEAD_ICON_SIZE.laptop}px!important;--pw-chrome-h:${PW_HEAD_ICON_SIZE.laptop}px!important}.pw-cat-btn:not([data-pw-chrome-added]) svg,.pw-shop-cat-btn:not([data-pw-chrome-added]) svg,[data-pw-el="cat-toggle"]:not([data-pw-chrome-added]) svg,.pw-chrome-cat-wrap svg{width:${PW_HEAD_ICON_SIZE.laptop}px!important;height:${PW_HEAD_ICON_SIZE.laptop}px!important;max-width:${PW_HEAD_ICON_SIZE.laptop}px!important;max-height:${PW_HEAD_ICON_SIZE.laptop}px!important}`
  ),
...
/** Product cards: mobile 2, tablet 3, laptop 4, desktop 5. */
...
${pwProductGridUnder('html[data-pw-edit-device="mobile"]')},${pwProductGridUnder('html[data-pw-scene-lock="mobile"]')}{grid-template-columns:repeat(2,minmax(0,1fr))!important}
${pwProductGridUnder('html[data-pw-edit-device="tablet"]')},${pwProductGridUnder('html[data-pw-scene-lock="tablet"]')}{grid-template-columns:repeat(3,minmax(0,1fr))!important}
...
${pwProductGridUnder('html:not([data-pw-edit-device]):not([data-pw-scene-lock])')}{grid-template-columns:repeat(3,minmax(0,1fr))!important}
}
...
${pwProductGridUnder('html:not([data-pw-edit-device]):not([data-pw-scene-lock])')}{grid-template-columns:repeat(5,minmax(0,1fr))!important}
}
`.trim()

/** Dedicated Tablet/Laptop density without changing the four-device editor contract. */
export const PARTNER_SHOP_TABLET_LAPTOP_POLISH_CSS = `
html[data-pw-edit-device="tablet"],html[data-pw-scene-lock="tablet"]{--pw-page-gutter:16px;--pw-block-w:min(calc(var(--pw-scene-w,768px) - 32px),var(--pw-content,1200px));--pw-chrome-inset:16px}
html[data-pw-edit-device="laptop"],html[data-pw-scene-lock="laptop"]{--pw-page-gutter:24px;--pw-block-w:min(calc(var(--pw-scene-w,1280px) - 48px),var(--pw-content,1200px));--pw-chrome-inset:48px}
html[data-pw-edit-device="tablet"] .pw-page-shell,html[data-pw-scene-lock="tablet"] .pw-page-shell,html[data-pw-edit-device="tablet"] .pw-shop-main,html[data-pw-scene-lock="tablet"] .pw-shop-main{padding-left:16px!important;padding-right:16px!important}
html[data-pw-edit-device="laptop"] .pw-page-shell,html[data-pw-scene-lock="laptop"] .pw-page-shell,html[data-pw-edit-device="laptop"] .pw-shop-main,html[data-pw-scene-lock="laptop"] .pw-shop-main{padding-left:24px!important;padding-right:24px!important}
html[data-pw-edit-device="tablet"] .pw-shop-account-layout,html[data-pw-scene-lock="tablet"] .pw-shop-account-layout{gap:16px!important}
html[data-pw-edit-device="tablet"] .pw-shop-account-sidebar,html[data-pw-scene-lock="tablet"] .pw-shop-account-sidebar{width:200px!important}
html[data-pw-edit-device="tablet"] .pw-shop-filters,html[data-pw-edit-device="tablet"] .pw-page-filters,html[data-pw-scene-lock="tablet"] .pw-shop-filters,html[data-pw-scene-lock="tablet"] .pw-page-filters{display:flex!important;flex-wrap:nowrap!important;overflow-x:auto!important;overflow-y:hidden!important;scrollbar-width:none;gap:6px!important}
html[data-pw-edit-device="tablet"] .pw-shop-filters::-webkit-scrollbar,html[data-pw-edit-device="tablet"] .pw-page-filters::-webkit-scrollbar,html[data-pw-scene-lock="tablet"] .pw-shop-filters::-webkit-scrollbar,html[data-pw-scene-lock="tablet"] .pw-page-filters::-webkit-scrollbar{display:none}
html[data-pw-edit-device="tablet"] .pw-shop-filters label,html[data-pw-edit-device="tablet"] .pw-page-filters label,html[data-pw-scene-lock="tablet"] .pw-shop-filters label,html[data-pw-scene-lock="tablet"] .pw-page-filters label{flex:0 0 auto!important;min-width:108px!important}
html[data-pw-edit-device="laptop"] .pw-shop-filters,html[data-pw-edit-device="laptop"] .pw-page-filters,html[data-pw-scene-lock="laptop"] .pw-shop-filters,html[data-pw-scene-lock="laptop"] .pw-page-filters{display:flex!important;flex-wrap:nowrap!important;overflow-x:auto!important;overflow-y:hidden!important;gap:8px!important}
@media ${pwUnlockedTabletMediaQuery()}{
html:not([data-pw-edit-device]):not([data-pw-scene-lock]){--pw-page-gutter:16px;--pw-block-w:min(calc(100% - 32px),var(--pw-content,1200px));--pw-chrome-inset:16px}
}
@media (min-width:1280px) and (max-width:1439px){
html:not([data-pw-edit-device]):not([data-pw-scene-lock]){--pw-page-gutter:24px;--pw-block-w:min(calc(100% - 48px),var(--pw-content,1200px));--pw-chrome-inset:48px}
}
`.trim()
...
${pwSceneCenterCss()}
${PARTNER_SHOP_TABLET_LAPTOP_POLISH_CSS}
...
.pw-pdp-sticky-nav svg,.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav svg,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav svg{width:17px!important;height:17px!important;max-width:17px!important;max-height:17px!important;display:block!important;margin:0 auto!important;flex-shrink:0!important;align-self:center!important}
...
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-personalize-banner]:not([data-pw-banner-live="off"]){
  background:var(--pw-surface,#fff)!important;
  color:inherit!important
}
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-personalize-banner]:not([data-pw-banner-live="off"]) [data-pw-slides],
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-personalize-banner]:not([data-pw-banner-live="off"]) [data-pw-el="copy"],
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-personalize-banner]:not([data-pw-banner-live="off"]) [data-pw-el="inner"],
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-personalize-banner]:not([data-pw-banner-live="off"]) [data-pw-slide-prev],
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-personalize-banner]:not([data-pw-banner-live="off"]) [data-pw-slide-next],
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-personalize-banner]:not([data-pw-banner-live="off"]) .pw-slide-dots,
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-personalize-banner]:not([data-pw-banner-live="off"]) img[data-pw-el="media"],
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-banner-placeholder]{display:none!important}
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-featured-categories]:not([data-pw-featured-live]) [data-pw-el="card"],
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-featured-categories]:not([data-pw-featured-live]) [data-pw-el="card-name"]{visibility:hidden}
html:not([data-pw-sample-preview]) body:not(.nanoai-ve-active) [data-pw-grid-placeholder]{visibility:hidden!important}
html[data-pw-sample-preview] [data-pw-personalize-banner] [data-pw-slides],
html[data-pw-sample-preview] [data-pw-personalize-banner] [data-pw-el="copy"],
html[data-pw-sample-preview] [data-pw-personalize-banner] [data-pw-el="inner"],
html[data-pw-sample-preview] [data-pw-personalize-banner] img[data-pw-el="media"]{display:block!important}
html[data-pw-sample-preview] [data-pw-featured-categories] [data-pw-el="card"],
html[data-pw-sample-preview] [data-pw-featured-categories] [data-pw-el="card-name"],
html[data-pw-sample-preview] [data-pw-sample-card]{visibility:visible!important}
html[data-pw-sample-preview] [data-pw-featured-categories] [data-pw-featured-clone]{display:none!important}
html[data-pw-sample-preview] [data-pw-featured-categories] .pw-featured-cat-marquee,
html[data-pw-sample-preview] [data-pw-featured-categories] [data-pw-featured-marquee]{
  animation:none!important;transform:none!important
}
html[data-pw-sample-preview] [data-pw-featured-categories] .pw-featured-cat-viewport,
html[data-pw-sample-preview] [data-pw-featured-categories] [data-pw-featured-viewport]{
  height:auto!important;overflow:visible!important
}
html .pw-nav-main,html .pw-shop-nav-row{width:var(--pw-block-w)!important;max-width:var(--pw-block-w)!important;margin-left:auto!important;margin-right:auto!important;align-self:center!important;flex:0 0 auto!important;box-sizing:border-box;justify-content:center!important;align-items:center!important;padding-left:var(--pw-chrome-inset,60px)!important;padding-right:var(--pw-chrome-inset,60px)!important}
html .pw-nav-main .pw-nav-row-scroll,html .pw-shop-nav-row .pw-nav-row-scroll{display:flex!important;flex-wrap:nowrap!important;justify-content:flex-start!important;align-items:center!important;width:max-content!important;max-width:100%!important;margin-left:auto!important;margin-right:auto!important;box-sizing:border-box}
@media (min-width:900px){
...
html .pw-topbar[data-pw-hidden="1"],html .pw-shop-topbar[data-pw-hidden="1"],html [data-pw-chrome-kit="topbar"][data-pw-hidden="1"],html [data-pw-region="topbar"][data-pw-hidden="1"],html .pw-topbar:not(:has([data-pw-chrome-btn]:not([data-pw-hidden="1"]))),html .pw-shop-topbar:not(:has([data-pw-chrome-btn]:not([data-pw-hidden="1"]))),html [data-pw-chrome-kit="topbar"]:not(:has([data-pw-chrome-btn]:not([data-pw-hidden="1"]))){display:none!important;min-height:0!important;height:0!important;max-height:0!important;overflow:hidden!important;padding:0!important;margin:0!important;border:0!important;pointer-events:none!important}
...
.pw-search-form input[type="search"],.pw-shop-search-form input[type="search"],input[data-pw-search],.pw-search-form .pw-search-compose,.pw-shop-search-form .pw-shop-search-compose,.pw-search-compose{flex:1 1 auto!important;min-width:0!important;width:auto!important;max-width:none!important}
...
html[data-pw-pdp-desktop-sticky="1"]:has([data-pw-page="product"]) .pw-shop-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"][data-pw-scene-lock="desktop"] .pw-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"][data-pw-scene-lock="laptop"] .pw-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"][data-pw-edit-device="desktop"] .pw-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"][data-pw-edit-device="laptop"] .pw-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"][data-pw-scene-lock="desktop"] .pw-shop-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"][data-pw-scene-lock="laptop"] .pw-shop-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"][data-pw-edit-device="desktop"] .pw-shop-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"][data-pw-edit-device="laptop"] .pw-shop-bottom-nav[data-pw-chrome-kit="dock"]{
  display:flex!important;position:fixed!important;left:0;right:0;bottom:0;z-index:${PW_SCENE_HEAD_Z}!important;background:#f3f4f6!important;border-top:1px solid #e5e7eb!important;min-height:64px!important;height:64px;align-items:stretch!important;justify-content:flex-start!important;gap:8px!important;padding:8px max(16px,calc((100% - 33rem) / 2))!important;box-sizing:border-box!important
}
html[data-pw-pdp-desktop-sticky="1"] [data-pw-live-dock]{display:flex!important;pointer-events:none;justify-content:center;align-items:stretch;background:#f3f4f6;border-top:1px solid #e5e7eb;min-height:64px}
html[data-pw-pdp-desktop-sticky="1"] [data-pw-live-dock]>.pw-bottom-nav,
html[data-pw-pdp-desktop-sticky="1"] [data-pw-live-dock]>.pw-shop-bottom-nav,
html[data-pw-pdp-desktop-sticky="1"] [data-pw-live-dock]>.pw-bottom-nav[data-pw-chrome-kit="dock"],
html[data-pw-pdp-desktop-sticky="1"] [data-pw-live-dock]>.pw-shop-bottom-nav[data-pw-chrome-kit="dock"]{
  display:flex!important;pointer-events:auto;position:relative!important;left:auto!important;right:auto!important;top:auto!important;bottom:auto!important;width:100%!important;max-width:33rem!important;margin:0 auto;min-height:64px!important;height:64px;padding:8px 16px!important;background:transparent!important;border-top:0!important;align-items:stretch!important;justify-content:flex-start!important;gap:8px!important;box-sizing:border-box!important
}
html[data-pw-pdp-desktop-sticky="1"] [data-pw-chrome-kit="dock"] .pw-pdp-sticky-ctas{align-self:stretch!important;align-items:stretch!important}
html[data-pw-pdp-desktop-sticky="1"] [data-pw-chrome-kit="dock"]>[data-pw-dock-show="pdp"][data-pw-chrome-btn="add-cart"]{margin-left:auto}
...
.pw-bottom-nav[data-pw-pdp-bottom],.pw-shop-bottom-nav[data-pw-pdp-bottom]{justify-content:flex-start!important;align-items:stretch!important;gap:6px!important;min-height:52px!important;padding:4px 6px calc(4px + env(safe-area-inset-bottom,0px))!important;background:#f3f4f6!important;border-top:1px solid #e5e7eb!important}
.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav{display:flex;align-items:stretch;justify-content:center;gap:2px;flex:0 0 auto;padding-right:6px;margin-right:2px;border-right:1px solid #e5e7eb}
.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-ctas,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-ctas{flex:1;min-width:0;display:flex;gap:4px;align-items:stretch}
.pw-bottom-nav[data-pw-pdp-bottom] .pw-shop-btn,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-shop-btn{flex:1;min-height:44px;padding:0 8px!important;font-size:11px!important;font-weight:600!important;line-height:1.15!important;text-transform:uppercase;border-radius:6px!important;color:#fff!important;background:var(--pw-cart)!important}
...
.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav a,.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav button,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav a,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav button{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;flex:0 0 44px!important;width:44px!important;min-width:44px!important;max-width:44px!important;gap:3px!important;padding:2px 0!important;font-size:10px!important;line-height:1.1!important;text-align:center!important;color:#4b5563!important;background:transparent!important;border:none!important;outline:none!important;box-shadow:none!important;-webkit-appearance:none!important;appearance:none!important;box-sizing:border-box!important}
.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav .is-try,.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav .is-fav,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav .is-try,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav .is-fav{border:none!important;outline:none!important;box-shadow:none!important;background:transparent!important;-webkit-appearance:none!important;appearance:none!important;aspect-ratio:auto!important}
.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav .is-try .pw-chrome-icon-wrap,.pw-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav .is-fav .pw-chrome-icon-wrap,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav .is-try .pw-chrome-icon-wrap,.pw-shop-bottom-nav[data-pw-pdp-bottom] .pw-pdp-sticky-nav .is-fav .pw-chrome-icon-wrap{border:none!important;outline:none!important;box-shadow:none!important;background:transparent!important;border-radius:0!important}
.pw-bottom-nav[data-pw-pdp-bottom] .is-try,.pw-shop-bottom-nav[data-pw-pdp-bottom] .is-try{color:var(--pw-primary)!important}
.pw-bottom-nav[data-pw-pdp-bottom] .is-fav[aria-pressed="true"],.pw-shop-bottom-nav[data-pw-pdp-bottom] .is-fav[aria-pressed="true"],.pw-bottom-nav[data-pw-pdp-bottom] .is-fav.is-active,.pw-shop-bottom-nav[data-pw-pdp-bottom] .is-fav.is-active{color:var(--pw-primary)!important}
...
html[data-pw-pdp-desktop-sticky="1"] [data-pw-chrome-kit="dock"] .pw-pdp-sticky-ctas,
html[data-pw-pdp-desktop-sticky="1"] [data-pw-live-dock] .pw-pdp-sticky-ctas{
  align-self:stretch!important;align-items:stretch!important;min-height:0
}
html[data-pw-pdp-desktop-sticky="1"] [data-pw-chrome-kit="dock"] [data-pw-dock-show="pdp"][data-pw-chrome-btn="add-cart"],
html[data-pw-pdp-desktop-sticky="1"] [data-pw-chrome-kit="dock"] [data-pw-dock-show="pdp"][data-pw-chrome-btn="buy-now"],
html[data-pw-pdp-desktop-sticky="1"] [data-pw-chrome-kit="dock"] .pw-pdp-sticky-ctas .pw-shop-btn,
html[data-pw-pdp-desktop-sticky="1"] [data-pw-chrome-kit="dock"] .pw-pdp-sticky-ctas .pw-shop-btn-buy,
html[data-pw-pdp-desktop-sticky="1"] [data-pw-chrome-kit="dock"] .pw-pdp-sticky-ctas [data-pw-kit-lock="cta"]{
  flex:1 1 0!important;min-width:160px!important;width:auto!important;max-width:none!important;
  height:auto!important;min-height:48px!important;max-height:none!important;align-self:stretch!important;
  padding:12px 20px!important;font-size:14px!important;line-height:1.2!important;font-weight:600!important;
  text-transform:uppercase;border-radius:8px!important;box-sizing:border-box!important
}
${pwHostPrefixCss(
  PW_SCENE_PHONE_HOSTS,
  `.pw-bottom-nav[data-pw-chrome-kit="dock"],.pw-shop-bottom-nav[data-pw-chrome-kit="dock"]{min-height:${PW_DOCK_BAR_MIN_H.mobile}px!important}.pw-pdp-sticky-nav .pw-chrome-icon-wrap,.pw-bottom-nav[data-pw-chrome-kit="dock"] .pw-pdp-sticky-nav .pw-chrome-icon-wrap,.pw-shop-bottom-nav[data-pw-chrome-kit="dock"] .pw-pdp-sticky-nav .pw-chrome-icon-wrap{width:${PW_PDP_DOCK_GLYPH.mobile}px!important;height:${PW_PDP_DOCK_GLYPH.mobile}px!important;max-width:${PW_PDP_DOCK_GLYPH.mobile}px!important;max-height:${PW_PDP_DOCK_GLYPH.mobile}px!important}.pw-pdp-sticky-nav svg,.pw-bottom-nav[data-pw-chrome-kit="dock"] .pw-pdp-sticky-nav svg,.pw-shop-bottom-nav[data-pw-chrome-kit="dock"] .pw-pdp-sticky-nav svg{width:${PW_PDP_DOCK_GLYPH.mobile}px!important;height:${PW_PDP_DOCK_GLYPH.mobile}px!important;max-width:${PW_PDP_DOCK_GLYPH.mobile}px!important;max-height:${PW_PDP_DOCK_GLYPH.mobile}px!important}`
)}
${pwSceneDeviceVisibilityCss()}
...
${PW_MOBILE_HEADER_TOPBAR_HIDE_CSS}
${PW_MOBILE_HEAD_BACK_CSS}
html[data-pw-edit-device="mobile"] .pw-brand-cluster,html[data-pw-edit-device="mobile"] .pw-shop-brand-cluster,html[data-pw-scene-lock="mobile"] .pw-brand-cluster,html[data-pw-scene-lock="mobile"] .pw-shop-brand-cluster,html[data-pw-edit-device="tablet"] .pw-brand-cluster,html[data-pw-edit-device="tablet"] .pw-shop-brand-cluster,html[data-pw-scene-lock="tablet"] .pw-brand-cluster,html[data-pw-scene-lock="tablet"] .pw-shop-brand-cluster{pointer-events:auto!important}
html[data-pw-edit-device="mobile"] .pw-cat-btn,html[data-pw-edit-device="mobile"] .pw-shop-cat-btn,html[data-pw-edit-device="mobile"] [data-pw-el="cat-toggle"],html[data-pw-edit-device="mobile"] [data-pw-cat-toggle],html[data-pw-edit-device="mobile"] .pw-chrome-cat-wrap,html[data-pw-edit-device="mobile"] [data-pw-chrome-btn="back"],html[data-pw-edit-device="mobile"] [data-pw-head-back],html[data-pw-scene-lock="mobile"] .pw-cat-btn,html[data-pw-scene-lock="mobile"] .pw-shop-cat-btn,html[data-pw-scene-lock="mobile"] [data-pw-el="cat-toggle"],html[data-pw-scene-lock="mobile"] [data-pw-cat-toggle],html[data-pw-scene-lock="mobile"] .pw-chrome-cat-wrap,html[data-pw-scene-lock="mobile"] [data-pw-chrome-btn="back"],html[data-pw-scene-lock="mobile"] [data-pw-head-back],html[data-pw-edit-device="tablet"] .pw-cat-btn,html[data-pw-edit-device="tablet"] .pw-shop-cat-btn,html[data-pw-edit-device="tablet"] [data-pw-el="cat-toggle"],html[data-pw-edit-device="tablet"] [data-pw-cat-toggle],html[data-pw-edit-device="tablet"] .pw-chrome-cat-wrap,html[data-pw-edit-device="tablet"] [data-pw-chrome-btn="back"],html[data-pw-edit-device="tablet"] [data-pw-head-back],html[data-pw-scene-lock="tablet"] .pw-cat-btn,html[data-pw-scene-lock="tablet"] .pw-shop-cat-btn,html[data-pw-scene-lock="tablet"] [data-pw-el="cat-toggle"],html[data-pw-scene-lock="tablet"] [data-pw-cat-toggle],html[data-pw-scene-lock="tablet"] .pw-chrome-cat-wrap,html[data-pw-scene-lock="tablet"] [data-pw-chrome-btn="back"],html[data-pw-scene-lock="tablet"] [data-pw-head-back]{position:relative!important;z-index:200!important;pointer-events:auto!important}
@media ${pwUnlockedBelowLaptopMediaQuery()}{html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-brand-cluster,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-brand-cluster{pointer-events:auto!important}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-cat-btn,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-cat-btn,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) [data-pw-el="cat-toggle"],html:not([data-pw-edit-device]):not([data-pw-scene-lock]) [data-pw-cat-toggle],html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-chrome-cat-wrap,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) [data-pw-chrome-btn="back"],html:not([data-pw-edit-device]):not([data-pw-scene-lock]) [data-pw-head-back]{position:relative!important;z-index:200!important;pointer-events:auto!important}}
${PW_DOCK_NAV_ACTIVE_CSS}
`.trim()
