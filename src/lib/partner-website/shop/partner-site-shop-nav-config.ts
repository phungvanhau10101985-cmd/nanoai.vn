...
export function getPartnerSiteAccountMenuItems(input: {
  ...
  return [
    ...
    {
      id: 'loyalty',
      href: tab('loyalty', paths.account),
      label: t.accountMenuLoyalty,
      emoji: partnerSiteAccountMenuEmoji('loyalty'),
    },
    {
      id: 'affiliate',
      href: tab('affiliate', paths.account),
      label: t.accountMenuAffiliate,
      emoji: partnerSiteAccountMenuEmoji('affiliate'),
    },
    {
      id: 'affiliate-bank',
      href: tab('affiliate-bank', paths.account),
      label: t.accountMenuAffiliateBank,
      emoji: partnerSiteAccountMenuEmoji('affiliate-bank'),
    },
    {
      id: 'notifications',
...
export function partnerSiteAccountMenuIconSvg(id: PartnerSiteAccountMenuItemId): string {
  const paths: Record<PartnerSiteAccountMenuItemId, string> = {
    ...
    loyalty:
      '<path d="M8 4h8v4a4 4 0 0 1-8 0V4z"/><path d="M8 6H5a3 3 0 0 0 3 3"/><path d="M16 6h3a3 3 0 0 1-3 3"/><path d="M12 12v3"/><path d="M9 21h6"/><path d="M10 18h4"/>',
    affiliate:
      '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',
    'affiliate-bank':
      '<path d="M3 10h18"/><path d="M5 10v10"/><path d="M19 10v10"/><path d="M3 20h18"/><path d="M12 4 3 10h18Z"/>',
    wishlist:
