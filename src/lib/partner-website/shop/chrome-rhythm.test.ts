...
test('chrome rhythm defaults stay distinct per device', () => {
  ...
  assert.equal(chromeHeadIconSizeForDevice('desktop'), 22)
  assert.equal(chromeHeadIconSizeForDevice('laptop'), 22)
  ...
  assert.ok(chromeHeadIconSizeForDevice('desktop') > chromeHeadIconSizeForDevice('tablet'))
...
test('legacy head seed values bump to current rhythm', () => {
  assert.equal(chromeHeadIconSizeFromLegacy(26, 'desktop'), 22)
  assert.equal(chromeHeadIconSizeFromLegacy(24, 'desktop'), 24)
  assert.equal(chromeHeadIconSizeFromLegacy(20, 'desktop'), 22)
  assert.equal(chromeHeadIconSizeFromLegacy(20, 'tablet'), 20)
  assert.equal(chromeHeadIconSizeFromLegacy(18, 'laptop'), 22)
  assert.equal(chromeHeadIconSizeFromLegacy(24, 'laptop'), 24)
  assert.equal(chromeHeadIconSizeFromLegacy(18, 'desktop'), 18)
