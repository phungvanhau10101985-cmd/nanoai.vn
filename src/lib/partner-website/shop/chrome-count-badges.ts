...
export const PW_CHROME_COUNT_BADGE_HIDE_CSS =
  ...
  'html[data-pw-edit-device="mobile"] .pw-header .pw-cart-badge:not([hidden]),html[data-pw-edit-device="mobile"] .pw-shop-header .pw-cart-badge:not([hidden]),html[data-pw-edit-device="tablet"] .pw-header .pw-cart-badge:not([hidden]),html[data-pw-edit-device="tablet"] .pw-shop-header .pw-cart-badge:not([hidden]),html[data-pw-scene-lock="mobile"] .pw-header .pw-cart-badge:not([hidden]),html[data-pw-scene-lock="mobile"] .pw-shop-header .pw-cart-badge:not([hidden]),html[data-pw-scene-lock="tablet"] .pw-header .pw-cart-badge:not([hidden]),html[data-pw-scene-lock="tablet"] .pw-shop-header .pw-cart-badge:not([hidden]),html[data-pw-edit-device="mobile"] .pw-header-actions .pw-cart-badge:not([hidden]),html[data-pw-edit-device="mobile"] .pw-shop-header-actions .pw-cart-badge:not([hidden]),html[data-pw-edit-device="tablet"] .pw-header-actions .pw-cart-badge:not([hidden]),html[data-pw-edit-device="tablet"] .pw-shop-header-actions .pw-cart-badge:not([hidden]){background:#fff!important;color:var(--pw-primary,#111)!important;-webkit-text-fill-color:var(--pw-primary,#111)!important;box-shadow:0 0 0 1px rgba(255,255,255,.45)!important}' +
  '@media (max-width:899px){html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-header .pw-cart-badge:not([hidden]),html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-header .pw-cart-badge:not([hidden]),html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-header .pw-shop-cart-badge:not([hidden]),html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-header .pw-shop-cart-badge:not([hidden]),html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-header-actions .pw-cart-badge:not([hidden]),html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-header-actions .pw-cart-badge:not([hidden]),html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-header-actions .pw-shop-cart-badge:not([hidden]),html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-header-actions .pw-shop-cart-badge:not([hidden]){background:#fff!important;color:var(--pw-primary,#111)!important;-webkit-text-fill-color:var(--pw-primary,#111)!important;box-shadow:0 0 0 1px rgba(255,255,255,.45)!important}}'
