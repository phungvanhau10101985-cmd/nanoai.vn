...
export const DEFAULT_PARTNER_SITE_FOOTER_LINKS: PartnerSiteNavLinkItem[] = [
  ...
  { id: 'ft_blog', hrefKey: 'blog', visible: true, sortOrder: 4 },
  { id: 'ft_home', hrefKey: 'home', visible: true, sortOrder: 5 },
  { id: 'ft_products', hrefKey: 'products', visible: true, sortOrder: 6 },
  { id: 'ft_sale', hrefKey: 'sale', visible: true, sortOrder: 7 },
  { id: 'ft_wishlist', hrefKey: 'wishlist', visible: true, sortOrder: 8 },
  { id: 'ft_size', hrefKey: 'size-guide', visible: true, sortOrder: 9 },
  { id: 'ft_cart', hrefKey: 'cart', visible: true, sortOrder: 10 },
  { id: 'ft_faq', hrefKey: 'faq', visible: true, sortOrder: 11 },
  { id: 'ft_shipping', hrefKey: 'shipping', visible: true, sortOrder: 12 },
  { id: 'ft_returns', hrefKey: 'returns', visible: true, sortOrder: 13 },
  { id: 'ft_payment', hrefKey: 'payment', visible: true, sortOrder: 14 },
  { id: 'ft_orders', hrefKey: 'orders', visible: true, sortOrder: 15 },
