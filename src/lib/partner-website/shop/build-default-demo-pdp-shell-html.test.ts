...
test('default demo PDP shell includes gallery, sizes, colors, qty, and reviews', () => {
  ...
  assert.doesNotMatch(html, /pw-pdp-total/)
  assert.doesNotMatch(html, /pw-pdp-notes/)
  assert.doesNotMatch(html, /pw-pdp-policy/)
...
test('bind keeps size, color, and actions inside the buy box', () => {
  ...
  assert.doesNotMatch(buyBox, /pw-pdp-total/)
  assert.doesNotMatch(buyBox, /pw-pdp-notes/)
  assert.doesNotMatch(buyBox, /pw-pdp-policy/)
