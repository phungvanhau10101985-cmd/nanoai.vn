...
test('bootstrap paints N slides on the first host and turns leftover widgets off', () => {
  ...
  assert.match(html, /aspect-ratio:var\(--pw-banner-ratio,21\/9\)/)
  assert.match(html, /flex-shrink:0/)
  assert.match(html, /display:block!important/)
  assert.match(html, /\[data-pw-promo-carousel\]\{position:relative/)
  assert.doesNotMatch(html, /\[data-pw-promo-carousel\]\{position:absolute;inset:0/)
  ...
  assert.match(html, /box\.insertAdjacentElement\('afterend',greet\)/)
