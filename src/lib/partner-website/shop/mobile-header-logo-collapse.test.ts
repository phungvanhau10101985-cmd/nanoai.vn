...
test('mobile logo collapse uses 188 hysteresis on live and Sửa nhanh', () => {
  ...
  assert.equal(PARTNER_SHOP_MOBILE_HEADER_LOGO_SCRIPT.includes('__pwMobileHeadLogoBoot'), true)
  assert.equal(PARTNER_SHOP_MOBILE_HEADER_LOGO_SCRIPT.includes('w<768'), true)
...
test('mobile header stack centers the logo row and keeps toolbar below', () => {
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('flex-wrap:nowrap!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('position:absolute!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('left:50%!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('padding:52px 10px 8px 8px!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('translate(-50%,0)'), true)
  ...
  assert.equal(PW_MOBILE_HEADER_STACK_WIN_CSS.includes('flex-wrap:nowrap!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_WIN_CSS.includes('display:contents!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_WIN_CSS.includes('left:50%!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_WIN_CSS.includes('position:static!important'), true)
  ...
  assert.equal(PW_MOBILE_HEADER_STACK_WIN_CSS.includes('[data-pw-inline-visual-root][data-pw-edit-device="mobile"]'), true)
  ...
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('padding:52px 10px 8px 8px!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('position:static!important'), true)
...
test('chrome layout injects mobile logo script and stack CSS once', () => {
  ...
  assert.equal(once.includes('flex-wrap:nowrap!important'), true)
  ...
  assert.equal(once.includes('padding:52px 10px 8px 8px!important'), true)
