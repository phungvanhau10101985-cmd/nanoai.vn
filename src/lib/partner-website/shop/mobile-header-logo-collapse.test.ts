...
test('mobile header stack centers the logo row and keeps toolbar below', () => {
  ...
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('padding:8px 10px!important'), true)
  assert.equal(PW_MOBILE_HEADER_STACK_RULES.includes('padding-left:8px!important'), true)
