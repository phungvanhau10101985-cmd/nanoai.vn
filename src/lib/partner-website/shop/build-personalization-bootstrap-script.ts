...
function renderRecommendedCard(p,badge){
  ...
  return '<article class="pw-product-card pw-rec-card" data-pw-el="card" data-inventory-id="'+id+'" data-pw-actions-ready="1"><div class="pw-product-card-media" data-pw-el="card-media">'+mark+fav+'<img src="'+img+'" alt="'+name+'" loading="lazy"/></div><div class="pw-product-card-body"><h3 data-pw-el="card-name"><a href="'+href+'">'+name+'</a></h3>'+(price?'<p class="pw-price" data-pw-el="card-price">'+price+'</p>':'')+listingStatsHtml(p)+'</div><a class="pw-product-card-hit" href="'+href+'" aria-label="'+name+'" tabindex="-1"></a></article>';
}
function renderCard(p,cta,badge,recommended){
  ...
  var price=priceHtml(p);
  var fav=listingFavHtml(id);
  return '<article class="pw-product-card" data-pw-el="card" data-inventory-id="'+id+'" data-pw-actions-ready="1"><div class="pw-product-card-media" data-pw-el="card-media">'+mark+fav+'<img src="'+img+'" alt="'+name+'" loading="lazy"/></div><div class="pw-product-card-body"><h3 data-pw-el="card-name"><a href="'+href+'">'+name+'</a></h3>'+(price?'<p class="pw-price" data-pw-el="card-price">'+price+'</p>':'')+listingStatsHtml(p)+'</div><a class="pw-product-card-hit" href="'+href+'" aria-label="'+name+'" tabindex="-1"></a></article>';
}
