...
${PW_LISTING_FAV_SEL}{position:absolute!important;top:4px!important;right:4px!important;left:auto!important;bottom:auto!important;z-index:8;display:inline-flex;width:44px!important;height:44px!important;max-width:44px!important;max-height:44px!important;align-items:center;justify-content:center;border:none;border-radius:999px;background:rgba(255,255,255,.92);color:#4b5563;cursor:pointer;padding:0;pointer-events:auto!important;font-size:0!important;line-height:0;overflow:hidden}
...
html .pw-rec-fav .pw-chrome-btn-label,html .pw-rec-fav .pw-shop-nav-label,html .pw-rec-fav .pw-pdp-like-copy,html .pw-rec-fav .pw-pdp-like-count{display:none!important}
...
html[data-pw-listing-category="1"] [data-pw-catalog]:not([data-pw-personalize]):not([data-pw-related]):not([data-pw-outfit]) [data-pw-el="section-more"],html[data-pw-listing-category="1"] [data-pw-catalog]:not([data-pw-personalize]):not([data-pw-related]):not([data-pw-outfit]) .pw-grid-all,body[data-pw-listing-category="1"] [data-pw-catalog]:not([data-pw-personalize]):not([data-pw-related]):not([data-pw-outfit]) [data-pw-el="section-more"],[data-pw-inline-visual-root][data-pw-listing-category="1"] [data-pw-catalog]:not([data-pw-personalize]):not([data-pw-related]):not([data-pw-outfit]) [data-pw-el="section-more"]{display:none!important}
`.trim()
