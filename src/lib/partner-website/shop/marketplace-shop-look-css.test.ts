...
test('marketplace look CSS paints chrome with tokens, not brand hex', () => {
  ...
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\)/)
  ...
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-featured-cat\{[^}]*background:var\(--pw-primary\)/)
  ...
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-shop-footer-col h3/)
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-shop-footer-name/)
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-footer,[^}]*color:#111827!important/)
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-shop-footer-col h3,[^}]*color:#111827!important/)
  assert.match(css, /background:var\(--pw-footer,#fff\)!important/)
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-nav-main \.pw-nav-pill>a:hover/)
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-nav-main \.pw-nav-pill:hover>a/)
  assert.match(css, /\.pw-nav-pill:hover>a\{[\s\S]*?color:#fff!important/)
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-nav-flyout-bar a/)
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-topbar a/)
  assert.match(css, /:is\(html\[data-pw-look="marketplace"\],\.pw-shop\[data-pw-look="marketplace"\]\) \.pw-shop-topbar a/)
})
