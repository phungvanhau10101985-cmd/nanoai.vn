...
html[data-pw-scene-lock="mobile"] [data-pw-personalize="recommended"] .pw-rec-personalize-label{min-height:26px;padding:0 4px;font-size:11px}
...
html [data-pw-personalize="recommended"] .pw-rec-fav .pw-pdp-like-copy,html [data-pw-personalize="recommended"] .pw-rec-fav .pw-chrome-btn-label{display:none!important}
