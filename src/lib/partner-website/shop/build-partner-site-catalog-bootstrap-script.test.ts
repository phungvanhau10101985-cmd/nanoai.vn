...
test('catalog bootstrap listing filters read URL, request facets, skip Sửa nhanh', () => {
  ...
  assert.match(s, /function dropListingSeeAll/)
  assert.match(s, /function gridHasMore/)
  assert.match(s, /if\(categoryListingEl\(el\)\)\{\s*dropListingSeeAll\(el\);\s*return more;/)
  assert.match(s, /function releaseListingGate/)
  assert.match(s, /data-pw-listing-filters-ready/)
  assert.match(s, /_pwGridGen/)
  assert.match(s, /data-pw-listing-filters-bound/)
  assert.match(s, /__pwBindListingFilters/)
