...
test('chrome layout css is injected once before </head>', () => {
  ...
  assert.equal(once.includes('html[data-pw-edit-device="mobile"]{--pw-scene-w:390px}'), true)
  assert.equal(once.includes('html[data-pw-edit-device] body{width:min(100%,var(--pw-scene-w));margin-left:auto;margin-right:auto}'), true)
