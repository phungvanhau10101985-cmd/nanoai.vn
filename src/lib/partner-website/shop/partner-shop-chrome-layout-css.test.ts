...
test('chrome layout css is injected once before </head>', () => {
  ...
  assert.equal(once.includes('grid-template-columns:minmax(200px,1.25fr) repeat(4,minmax(0,1fr))!important'), true)
  assert.equal(once.includes('html .pw-shop-footer-brand,html .pw-footer-brand{grid-column:auto!important}'), true)
  ...
  assert.equal(once.includes('html[data-pw-scene-lock="desktop"] .pw-bottom-nav,html[data-pw-scene-lock="desktop"] .pw-shop-bottom-nav,html[data-pw-scene-lock="laptop"] .pw-bottom-nav,html[data-pw-scene-lock="laptop"] .pw-shop-bottom-nav,html[data-pw-edit-device="desktop"] .pw-bottom-nav,html[data-pw-edit-device="desktop"] .pw-shop-bottom-nav,html[data-pw-edit-device="laptop"] .pw-bottom-nav,html[data-pw-edit-device="laptop"] .pw-shop-bottom-nav{display:none!important}'), true)
