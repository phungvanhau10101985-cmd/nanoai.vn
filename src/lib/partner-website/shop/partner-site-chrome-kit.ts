...
${pwProductDockCss(`[${PW_CHROME_KIT_ATTR}="dock"]`, `{
  justify-content:flex-start!important;align-items:stretch!important;gap:6px!important;min-height:52px!important;
  padding:4px 6px calc(4px + env(safe-area-inset-bottom,0px))!important;background:#f3f4f6!important;border-top:1px solid #e5e7eb!important
}`)}
${pwProductDockCss(' .pw-pdp-sticky-nav', '{display:flex!important;flex-direction:row!important;align-items:stretch;justify-content:center;gap:2px;flex:0 0 auto;padding:0 6px 0 0;margin:0 2px 0 0;border-right:1px solid #e5e7eb}')}
${pwProductDockCss(' .pw-pdp-sticky-ctas', '{display:flex!important;flex-direction:row!important;flex:1;min-width:0;gap:4px;align-items:stretch}')}
...
${pwProductDockCss(` .pw-pdp-sticky-nav [${PW_DOCK_SHOW_ATTR}="pdp"]:not([${PW_HIDDEN_ATTR}="1"])`, '{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;flex:0 0 44px!important;width:44px!important;min-width:44px!important;max-width:44px!important;gap:3px!important;padding:2px 0!important;font-size:10px!important;line-height:1.1!important;text-align:center!important;color:#4b5563!important;background:transparent!important;border:none!important;outline:none!important;box-shadow:none!important;-webkit-appearance:none!important;appearance:none!important;box-sizing:border-box!important}')}
${pwProductDockCss(' .pw-pdp-sticky-nav .is-try,.pw-pdp-sticky-nav .is-fav,.pw-pdp-sticky-nav [data-pw-chrome-btn="try-on"],.pw-pdp-sticky-nav [data-pw-chrome-btn="favorite-product"]', '{border:none!important;outline:none!important;box-shadow:none!important;background:transparent!important;-webkit-appearance:none!important;appearance:none!important;aspect-ratio:auto!important}')}
${pwProductDockCss(' .pw-pdp-sticky-nav .is-try .pw-chrome-icon-wrap,.pw-pdp-sticky-nav .is-fav .pw-chrome-icon-wrap,.pw-pdp-sticky-nav [data-pw-chrome-btn="try-on"] .pw-chrome-icon-wrap,.pw-pdp-sticky-nav [data-pw-chrome-btn="favorite-product"] .pw-chrome-icon-wrap', '{border:none!important;outline:none!important;box-shadow:none!important;background:transparent!important;border-radius:0!important}')}
${pwProductDockCss(` .pw-pdp-sticky-ctas [${PW_DOCK_SHOW_ATTR}="pdp"]`, '{display:flex!important;flex:1 1 0!important;align-self:stretch!important;min-height:44px!important;height:auto!important;max-height:none!important;align-items:center!important;justify-content:center!important;padding:0 8px!important;font-size:11px!important;font-weight:600!important;line-height:1.15!important;text-transform:uppercase;border-radius:6px!important;color:#fff!important;box-sizing:border-box!important}')}
${pwProductDockCss(' .pw-pdp-sticky-nav .pw-chrome-icon-wrap', '{display:flex!important;align-items:center!important;justify-content:center!important;width:17px!important;height:17px!important;max-width:17px!important;max-height:17px!important;margin:0 auto!important;flex-shrink:0!important}')}
${pwProductDockCss(' .pw-pdp-sticky-nav svg', '{width:17px!important;height:17px!important;max-width:17px!important;max-height:17px!important;display:block!important;margin:0 auto!important;flex-shrink:0!important;align-self:center!important}')}
${pwProductDockCss(' .pw-pdp-sticky-nav .pw-pdp-sticky-copy', '{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:flex-start!important;width:100%!important;max-width:100%!important;gap:0!important;line-height:1.1!important;text-align:center!important}')}
${pwProductDockCss(' .pw-pdp-sticky-nav .pw-pdp-like-copy', '{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:flex-start!important;width:100%!important;max-width:100%!important;gap:0!important;line-height:1.1!important;text-align:center!important}')}
${pwProductDockCss(' .pw-pdp-sticky-nav .pw-pdp-sticky-copy>span', '{display:block!important;width:100%!important;text-align:center!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;font-size:10px!important;line-height:1.1!important}')}
${pwProductDockCss(' .pw-pdp-sticky-nav .pw-pdp-like-copy>span', '{display:block!important;width:100%!important;text-align:center!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;font-size:10px!important;line-height:1.1!important}')}
