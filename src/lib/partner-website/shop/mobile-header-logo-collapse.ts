...
.pw-header a.pw-brand:not([data-pw-logo-float]),.pw-shop-header a.pw-shop-brand:not([data-pw-logo-float]),.pw-header a[data-pw-logo-home]:not([data-pw-logo-float]),.pw-shop-header a[data-pw-logo-home]:not([data-pw-logo-float]){order:-1!important;flex:1 1 100%!important;width:100%!important;max-width:100%!important;justify-content:center!important;align-items:center!important;position:relative!important;left:auto!important;top:auto!important;right:auto!important;bottom:auto!important;transform:translate(var(--pw-logo-x, 0px), var(--pw-logo-y, 0px))!important;display:flex!important;min-height:0!important;max-height:44px!important;overflow:visible!important;margin:0!important;transition:max-height .2s ease-out,opacity .2s ease-out,min-height .2s ease-out,margin .2s ease-out!important}
