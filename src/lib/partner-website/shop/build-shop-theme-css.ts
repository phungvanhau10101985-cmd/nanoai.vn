...
.pw-shop-account-layout{display:grid;gap:16px}
@media(min-width:768px){.pw-shop-account-layout{grid-template-columns:240px minmax(0,1fr);gap:20px;align-items:start;padding:16px;border-radius:16px;background:var(--pw-surface)}}
.pw-shop-account-sidebar{display:none}
@media(min-width:768px){.pw-shop-account-sidebar{display:block;position:sticky;top:calc(var(--pw-sticky-head,72px) + 12px)}}
.pw-shop-account-nav-kicker{margin:0 0 8px;padding:0 10px;font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--pw-muted,#6b7280)}
.pw-shop-account-nav{background:transparent;border:none;border-radius:0;overflow:visible;box-shadow:none;display:grid;gap:2px}
.pw-shop-account-nav-item{display:flex;align-items:center;gap:10px;padding:8px 10px;border:none;border-left:3px solid transparent;border-radius:10px;background:transparent;font-weight:500;font-size:13px;color:#6b7280;cursor:pointer;width:100%;text-align:left;text-decoration:none;line-height:1.25}
.pw-shop-account-nav-item:hover{background:#fff;color:var(--pw-text,#111827)}
.pw-shop-account-nav-item.is-active{background:#fff;color:var(--pw-primary);border-left-color:var(--pw-primary);font-weight:600;box-shadow:0 1px 2px rgba(15,23,42,.06)}
.pw-shop-account-nav-item.is-header.is-active{font-weight:700}
.pw-shop-account-nav-item.is-accent{background:#fff;color:var(--pw-accent);border-left-color:var(--pw-primary)}
.pw-shop-account-nav-item.is-logout{margin-top:8px;border-top:none;color:#b91c1c}
.pw-shop-account-nav-item.is-logout:hover{background:#fef2f2}
.pw-shop-account-nav-ico{width:28px;height:28px;border-radius:8px;background:#fff;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0}
.pw-shop-account-nav-item.is-active .pw-shop-account-nav-ico{background:color-mix(in srgb,var(--pw-primary) 12%,#fff)}
.pw-shop-account-nav-icon{width:16px;height:16px;flex-shrink:0;opacity:.9}
.pw-shop-account-nav-badge{margin-left:auto;min-width:18px;height:18px;padding:0 5px;border-radius:999px;background:var(--pw-primary);color:#fff;font-size:11px;font-weight:700;display:inline-flex;align-items:center;justify-content:center}
.pw-shop-account-content{min-width:0;background:#fff;border:1px solid var(--pw-border,#e5e7eb);border-radius:14px;padding:18px 16px;box-shadow:0 1px 2px rgba(15,23,42,.04)}
@media(min-width:768px){.pw-shop-account-content{padding:24px 28px;min-height:420px}}
...
html:is([data-pw-edit-device="desktop"],[data-pw-edit-device="laptop"],[data-pw-scene-lock="desktop"],[data-pw-scene-lock="laptop"]) .pw-pdp-detail-photos,html:is([data-pw-edit-device="desktop"],[data-pw-edit-device="laptop"],[data-pw-scene-lock="desktop"],[data-pw-scene-lock="laptop"]) [data-pw-pdp-slot="detail-images"],[data-pw-visual-device="desktop"] .pw-pdp-detail-photos,[data-pw-visual-device="laptop"] .pw-pdp-detail-photos{width:100%;max-width:min(100%,calc(56rem / var(--pw-scene-zoom,1)));margin-left:auto;margin-right:auto;min-width:0;overflow-x:clip}
...
@media(min-width:1280px){html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-detail{width:100%;max-width:var(--pw-content,1200px);margin-left:auto;margin-right:auto;padding-left:var(--pw-page-gutter,20px);padding-right:var(--pw-page-gutter,20px);box-sizing:border-box;overflow-x:clip}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-layout{max-width:100%;min-width:0;overflow-x:clip}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-gallery-desktop .pw-shop-product-img,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-gallery-desktop [data-pw-el="main-image"]{width:100%;max-width:100%;height:auto!important;max-height:calc(70vh / var(--pw-scene-zoom,1));aspect-ratio:auto!important;object-fit:contain!important;object-position:center top}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-detail-photos,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) [data-pw-pdp-slot="detail-images"]{width:100%;max-width:min(100%,calc(56rem / var(--pw-scene-zoom,1)));margin-left:auto;margin-right:auto;min-width:0;overflow-x:clip}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-detail-photos img,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) [data-pw-pdp-slot="detail-images"] img,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-detail-body img{width:100%;max-width:100%;height:auto;display:block;margin-left:auto;margin-right:auto;border-radius:12px;border:1px solid var(--pw-border);box-sizing:border-box}}
...
.pw-shop-cart-row{display:grid;gap:12px;padding:12px;border:1px solid #f3f4f6;border-radius:12px;background:#fff;grid-template-columns:72px 1fr auto;align-items:center;box-shadow:0 1px 4px rgba(15,23,42,.04)}
...
.pw-shop-cart-summary{background:#fff;border:1px solid var(--pw-border,#e5e7eb);border-radius:12px;padding:16px;display:grid;gap:10px;box-shadow:0 1px 4px rgba(15,23,42,.04)}
