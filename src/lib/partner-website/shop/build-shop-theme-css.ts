...
.pw-shop{min-height:100dvh;background:
  ...
  var(--pw-bg);color:var(--pw-text);font-family:var(--pw-font-ui), ${theme.fontFamily};line-height:1.6;padding-bottom:72px}
.pw-shop h1,.pw-shop h2,.pw-shop-info h1{font-family:var(--pw-font-display), Georgia, serif}
...
.pw-shop-btn{display:inline-flex;align-items:center;justify-content:center;padding:10px 18px;border-radius:8px;border:none;background:var(--pw-primary);color:#fff;font-weight:800;cursor:pointer;text-decoration:none;font-size:12px;letter-spacing:.04em;text-transform:uppercase}
...
.pw-shop-form input,.pw-shop-form textarea{padding:10px 12px;border:1px solid #d1d5db;border-radius:8px;font:inherit}
