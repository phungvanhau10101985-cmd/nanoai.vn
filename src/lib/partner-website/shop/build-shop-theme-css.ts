...
import { PW_SHOP_ACCOUNT_COMMERCE_POLISH_CSS } from '@/lib/partner-website/shop/partner-site-account-commerce-polish-css'
import { PW_SHOP_FOOTER_FIT_CSS } from '@/lib/partner-website/shop/partner-site-footer-fit-css'
import { PW_SHOP_ORDER_STATUS_TABS_CSS } from '@/lib/partner-website/shop/partner-site-order-status-tabs-css'
import {
  PW_CHROME_BTN_MIN_H,
  PW_CHROME_H_VAR,
...
.pw-search-submit{border:none;background:var(--pw-primary);color:#fff;font-weight:800;font-size:12px;letter-spacing:.04em;text-transform:uppercase;padding:0 16px;cursor:pointer;white-space:nowrap;display:inline-flex;flex-direction:row;align-items:center;justify-content:center;text-decoration:none}
...
.pw-nav-row-scroll{display:flex;flex-wrap:nowrap;justify-content:flex-start;align-items:center;gap:inherit;width:max-content;max-width:100%;margin-left:auto;margin-right:auto;overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch;scrollbar-width:none}
...
/** Every cart surface: 3-col lines, money never clipped, voucher/address/actions stay inside the viewport. */
const PW_SHOP_CART_COMPACT_LAYOUT_CSS = `.pw-shop-cart,.pw-shop-cart *{box-sizing:border-box}
.pw-shop-cart,.pw-shop-cart-layout,.pw-shop-cart-list,.pw-shop-cart-summary,.pw-shop-cart-promo,.pw-shop-cart .pw-shop-form,.pw-shop-cart .pw-shop-address-pick{min-width:0;max-width:100%;width:100%}
.pw-shop-cart-row{grid-template-columns:22px 64px minmax(0,1fr);align-items:start;gap:10px;padding:10px;min-width:0;max-width:100%}
...
.pw-shop-cart-line-expected,.pw-shop-cart-line-save,.pw-shop-cart-line-count{max-width:100%;overflow-wrap:anywhere}
.pw-shop-cart-line-total-wrap{grid-column:1/-1;min-width:0;width:100%;display:flex;flex-wrap:wrap;justify-content:flex-end;align-items:baseline;gap:4px 10px;padding-top:8px;margin-top:2px;border-top:1px solid var(--pw-border);text-align:right}
.pw-shop-cart-row[data-pw-cart-qty="1"] .pw-shop-cart-line-total-wrap{display:none}
.pw-shop-cart-line-total{margin-left:auto;white-space:normal;overflow-wrap:anywhere}
.pw-shop-cart-row-tools{justify-content:space-between;width:100%}
.pw-shop-cart-select-all{padding:8px 10px;font-size:13px;gap:8px;flex-wrap:wrap}
.pw-shop-cart-discount-breakdown p:not(.pw-shop-cart-section):not(.pw-shop-cart-saved):not(.pw-shop-cart-cap-meter):not(.pw-shop-cart-promo-msg){display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:baseline;flex-wrap:unset}
.pw-shop-cart-discount-breakdown p span{min-width:0;flex:unset;overflow-wrap:anywhere}
.pw-shop-cart-discount-breakdown p strong{flex:unset;white-space:normal;overflow-wrap:anywhere;font-variant-numeric:tabular-nums}
.pw-shop-cart-saved,.pw-shop-cart-cap-meter,.pw-shop-cart-deposit-note,.pw-shop-cart-grand,.pw-shop-cart p.pw-shop-muted{display:block;white-space:normal;overflow-wrap:anywhere}
.pw-shop-cart-summary{padding:12px 10px;min-width:0;max-width:100%;overflow-x:visible}
.pw-shop-cart-summary .pw-shop-form,.pw-shop-cart-summary .pw-shop-form input:not([type="checkbox"]):not([type="radio"]),.pw-shop-cart-summary .pw-shop-form textarea,.pw-shop-cart-summary .pw-shop-form select,.pw-shop-cart-summary .pw-shop-btn{max-width:100%;width:100%;min-width:0;justify-content:center}
.pw-shop-cart-promo-row{display:grid;grid-template-columns:1fr;gap:8px;width:100%}
.pw-shop-cart-promo-row input,.pw-shop-cart-promo-row .pw-shop-btn,.pw-shop-cart-promo-row .pw-shop-price{width:100%;min-width:0;overflow-wrap:anywhere}
.pw-shop-cart-wallet>label,.pw-shop-cart-affiliate-wallet label{min-width:0;max-width:100%}
.pw-shop-cart-wallet>label span,.pw-shop-cart-affiliate-wallet span{min-width:0;overflow-wrap:anywhere;word-break:break-word}
.pw-shop-cart .pw-shop-address-pick-item{min-width:0;max-width:100%}
.pw-shop-cart .pw-shop-address-pick-item input{flex-shrink:0;margin-top:3px}
.pw-shop-cart .pw-shop-address-pick-item>span{min-width:0;overflow-wrap:anywhere;word-break:break-word}
.pw-shop-cart-summary .pw-shop-address-form-actions{display:grid;grid-template-columns:1fr;width:100%;margin-top:8px}
.pw-shop-cart-summary .pw-shop-address-form-actions .pw-shop-btn{width:100%;white-space:normal;text-align:center}
.pw-shop-cart-actions{flex-direction:column}
.pw-shop-cart-actions .pw-shop-btn{width:100%;flex:none}
.pw-shop-cart h1{font-size:1.2rem}
.pw-shop-cart-chip{white-space:normal;line-height:1.25;max-width:100%}
.pw-shop-account-content:has(.pw-shop-cart){padding:8px 0 12px;border-radius:12px;overflow-x:visible}
.pw-shop-main:has(.pw-shop-cart){padding-left:var(--pw-page-gutter,4px);padding-right:var(--pw-page-gutter,4px);padding-bottom:calc(24px + 80px);overflow-x:visible}
@media(min-width:1280px){.pw-shop-cart-promo-row{grid-template-columns:minmax(0,1fr) max-content}.pw-shop-cart-promo-row .pw-shop-btn{width:auto;min-width:max-content;white-space:nowrap}.pw-shop-cart-summary .pw-shop-address-form-actions{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.pw-shop-cart-actions{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);flex-direction:unset}.pw-shop-cart-actions .pw-shop-btn,.pw-shop-cart-actions a.pw-shop-btn{width:100%;white-space:nowrap}}`
...
.pw-shop-cart-affiliate-wallet span{min-width:0;font-size:12px;color:var(--pw-muted,#6b7280);overflow-wrap:anywhere}`
...
.pw-shop-deposit-money>div:not(.pw-shop-deposit-level){padding:8px 6px;text-align:center;border-right:1px solid var(--pw-border,#e5e7eb)}
.pw-shop-deposit-money>div:nth-child(3){border-right:none}
...
.pw-shop-deposit-level{grid-column:1/-1;padding:8px 10px;text-align:left;background:var(--pw-bg,#fff);border-right:none}
...
@media (min-width:768px){.pw-shop-category-hub{grid-template-columns:repeat(3,minmax(0,1fr))}}
@media (min-width:1280px){.pw-shop-category-hub{grid-template-columns:repeat(4,minmax(0,1fr))}}
@media (min-width:1440px){.pw-shop-category-hub{grid-template-columns:repeat(5,minmax(0,1fr))}}
...
@media(min-width:768px){.pw-shop-search-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}
...
.pw-shop-account-panel a.is-header{background:color-mix(in srgb,var(--pw-primary) 12%,#fff);color:var(--pw-primary);border-left:3px solid var(--pw-primary);border-radius:8px 8px 8px 6px;font-weight:700}
.pw-shop-account-panel a.is-header:hover{background:color-mix(in srgb,var(--pw-primary) 22%,#fff);color:var(--pw-primary)}
...
.pw-shop-account-panel a.is-header .pw-shop-account-icon{color:var(--pw-primary)}
...
.pw-shop-account-layout{display:flex;flex-direction:column;gap:16px;min-width:0;max-width:100%;width:100%}
@media(min-width:768px){.pw-shop-account-layout{flex-direction:row;gap:16px;align-items:flex-start}}
@media(min-width:1280px){.pw-shop-account-layout{gap:24px}}
.pw-shop-account-sidebar{display:none}
@media(min-width:768px){.pw-shop-account-sidebar{display:block;width:200px;flex-shrink:0;position:sticky;top:calc(var(--pw-sticky-head,72px) + 12px)}}
...
.pw-shop-account-content{min-width:0;flex:1;background:#fff;border:1px solid var(--pw-border,#e5e7eb);border-radius:16px;padding:16px;box-shadow:0 1px 2px rgba(15,23,42,.04);max-width:100%;overflow-x:visible}
@media(min-width:768px){.pw-shop-account-content{padding:18px;min-height:420px}}
...
.pw-shop-account-hub-order-row{display:flex;flex-wrap:nowrap;gap:8px;overflow-x:auto;overflow-y:hidden;padding:0 4px 4px;margin:0 -4px;-webkit-overflow-scrolling:touch;scrollbar-width:none;overscroll-behavior-inline:contain}
...
.pw-shop-account-hub-order-chip span:first-child{font-size:12px;font-weight:500;line-height:1.25;white-space:nowrap}
...
.pw-shop-orders-list{list-style:none;padding:0;margin-top:16px;display:grid;gap:16px}
.pw-shop-order-card{overflow:hidden;border:1px solid var(--pw-border,#dbe2ea);border-top:3px solid color-mix(in srgb,var(--pw-primary) 55%,var(--pw-border,#dbe2ea));border-radius:14px;padding:0;background:#fff;box-shadow:0 2px 8px rgba(15,23,42,.07)}
.pw-shop-order-card-top{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:11px 16px;border-bottom:1px solid var(--pw-border,#e5e7eb);background:color-mix(in srgb,var(--pw-surface,#f8fafc) 82%,#fff)}
.pw-shop-order-card-identity{display:flex;min-width:0;align-items:baseline;gap:7px;flex-wrap:wrap}
.pw-shop-order-card-identity>span{font-size:11px;font-weight:600;color:var(--pw-muted,#6b7280)}
.pw-shop-order-card-identity>strong{font-size:13px;color:var(--pw-text,#111827);overflow-wrap:anywhere}
.pw-shop-order-card-identity>time{font-size:11px;color:var(--pw-muted,#6b7280)}
.pw-shop-order-card-statuses{display:flex;flex:0 0 auto;align-items:center;justify-content:flex-end;gap:6px;flex-wrap:wrap}
.pw-shop-order-status,.pw-shop-order-shipping-status{display:inline-flex;align-items:center;min-height:26px;padding:4px 9px;border-radius:999px;font-size:11px;font-weight:700;line-height:1.1;white-space:nowrap}
.pw-shop-order-status{background:color-mix(in srgb,var(--pw-primary) 12%,#fff);color:var(--pw-primary)}
.pw-shop-order-shipping-status{border:1px solid var(--pw-border,#e5e7eb);background:#fff;color:var(--pw-muted,#4b5563)}
.pw-shop-order-card-head{display:flex;gap:14px;align-items:flex-start;padding:16px}
...
.pw-shop-order-actions{margin-top:0;padding:12px 16px;display:flex;flex-wrap:wrap;gap:8px;border-top:1px solid var(--pw-border,#e5e7eb);background:color-mix(in srgb,var(--pw-surface,#f8fafc) 55%,#fff)}
@media(max-width:767px){
  .pw-shop-account-content:not(:has(.pw-shop-account-hub-mobile)){padding:12px 10px;border-radius:14px}
  .pw-shop-account-content h1{font-size:1.2rem}
  .pw-shop-orders-list{margin-top:12px;gap:10px}
  .pw-shop-order-card{padding:0;border-top-width:2px}
  .pw-shop-order-card-top{align-items:flex-start;padding:9px 12px}
  .pw-shop-order-card-identity{display:grid;gap:2px}
  .pw-shop-order-card-identity>span{display:none}
  .pw-shop-order-card-statuses{max-width:52%;gap:4px}
  .pw-shop-order-status,.pw-shop-order-shipping-status{min-height:22px;padding:3px 7px;font-size:10px}
  .pw-shop-order-card-head{gap:10px;padding:12px}
  .pw-shop-order-thumb{width:64px;height:64px}
  .pw-shop-order-actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;padding:10px 12px}
  .pw-shop-order-actions .pw-shop-btn{width:100%;min-width:0;padding-left:8px;padding-right:8px;white-space:normal;text-align:center;line-height:1.2}
  .pw-shop-order-payment{margin-left:12px;margin-right:12px;margin-bottom:12px}
}
...
.pw-shop-address-form-actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:16px;min-width:0;max-width:100%}
.pw-shop-address-form-actions .pw-shop-btn{max-width:100%;box-sizing:border-box}
...
.pw-shop-address-pick{display:grid;gap:10px;margin:0 0 16px;min-width:0;max-width:100%}
.pw-shop-address-pick-item{display:flex;gap:10px;align-items:flex-start;padding:12px;border:1px solid var(--pw-border);border-radius:12px;background:#fff;cursor:pointer;min-width:0;max-width:100%}
.pw-shop-address-pick-item>span{min-width:0;overflow-wrap:anywhere;word-break:break-word}
...
html[data-pw-edit-device="mobile"] [data-pw-pdp-slot="breadcrumb"],html[data-pw-scene-lock="mobile"] [data-pw-pdp-slot="breadcrumb"],[data-pw-inline-visual-root][data-pw-edit-device="mobile"] [data-pw-pdp-slot="breadcrumb"],[data-pw-visual-device="mobile"] [data-pw-pdp-slot="breadcrumb"],html[data-pw-edit-device="mobile"][data-pw-page="product"] [data-pw-region="breadcrumb"],html[data-pw-scene-lock="mobile"][data-pw-page="product"] [data-pw-region="breadcrumb"],html[data-pw-edit-device="mobile"] [data-pw-page="product"] [data-pw-region="breadcrumb"],html[data-pw-scene-lock="mobile"] [data-pw-page="product"] [data-pw-region="breadcrumb"],[data-pw-inline-visual-root][data-pw-edit-device="mobile"][data-pw-page="product"] [data-pw-region="breadcrumb"]{display:none!important}
@media (max-width:767px){html:not([data-pw-edit-device="tablet"]):not([data-pw-edit-device="laptop"]):not([data-pw-edit-device="desktop"]):not([data-pw-scene-lock="tablet"]):not([data-pw-scene-lock="laptop"]):not([data-pw-scene-lock="desktop"]) [data-pw-pdp-slot="breadcrumb"],html:not([data-pw-edit-device="tablet"]):not([data-pw-edit-device="laptop"]):not([data-pw-edit-device="desktop"]):not([data-pw-scene-lock="tablet"]):not([data-pw-scene-lock="laptop"]):not([data-pw-scene-lock="desktop"])[data-pw-page="product"] [data-pw-region="breadcrumb"],html:not([data-pw-edit-device="tablet"]):not([data-pw-edit-device="laptop"]):not([data-pw-edit-device="desktop"]):not([data-pw-scene-lock="tablet"]):not([data-pw-scene-lock="laptop"]):not([data-pw-scene-lock="desktop"]) [data-pw-page="product"] [data-pw-region="breadcrumb"]{display:none!important}}
...
@media(min-width:768px){.pw-shop-grid{gap:14px;grid-template-columns:repeat(3,minmax(0,1fr))}}
...
.pw-shop-card{display:flex;flex-direction:column;height:100%;border:1px solid var(--pw-border,#f3f4f6);border-radius:10px;overflow:hidden;background:var(--pw-surface,#fff);box-shadow:0 4px 14px rgba(15,23,42,.06)}
.pw-shop-card img{width:100%;aspect-ratio:1;object-fit:cover}
.pw-shop-card-body{padding:8px;display:flex;flex-direction:column;flex:1 1 auto;gap:4px}
.pw-shop-card-body h3,.pw-shop-card [data-pw-el="card-name"]{margin:0;font-size:12px;font-weight:500;line-height:1.25;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;word-break:break-word;min-height:2rem;max-height:2rem}
.pw-shop-card-body > .pw-shop-btn,.pw-shop-card-body > [data-pw-el="card-buy"]{display:none!important}
...
.pw-shop-deposit-money>div:not(.pw-shop-deposit-level){padding:10px 10px;text-align:center;border-right:1px solid var(--pw-border,#e5e7eb)}
@media(min-width:900px){.pw-shop-deposit-money>div:not(.pw-shop-deposit-level){padding:12px 14px;text-align:left}}
.pw-shop-deposit-money>div:nth-child(3){border-right:none}
...
.pw-shop-deposit-level{grid-column:1/-1;padding:10px 16px;text-align:left;background:var(--pw-bg,#fff);border-top:1px solid var(--pw-border,#e5e7eb);border-right:none}
.pw-shop-deposit-level .lbl{margin:0 0 8px;font-size:14px;font-weight:700}
@media(min-width:900px){.pw-shop-deposit-level{padding:12px 16px}.pw-shop-deposit-opts{flex-direction:row;flex-wrap:wrap;gap:20px 28px}}
...
@keyframes pw-shop-spin{to{transform:rotate(360deg)}}
.pw-shop-deposit-qr-modal{position:fixed;inset:0;z-index:120;display:flex;align-items:flex-end;justify-content:center;background:rgba(0,0,0,.6);padding:16px}
@media(min-width:640px){.pw-shop-deposit-qr-modal{align-items:center}}
.pw-shop-deposit-qr-modal-card{width:100%;max-width:24rem;border-radius:16px;background:#fff;padding:16px;box-shadow:0 20px 40px rgba(0,0,0,.18);display:grid;gap:12px}
.pw-shop-deposit-qr-modal-card h2{margin:0;text-align:center;font-size:16px;color:#111827}
.pw-shop-deposit-qr-modal-card p{margin:0;text-align:center;font-size:14px;line-height:1.45;color:#4b5563}
.pw-shop-deposit-qr-modal-img{display:flex;justify-content:center;border:1px solid var(--pw-border,#e5e7eb);border-radius:12px;background:var(--pw-surface,#f9fafb);padding:12px}
.pw-shop-deposit-qr-modal-img img{width:min(100%,280px);height:auto}
...
html[data-pw-edit-device="tablet"] .pw-shop-product-layout,html[data-pw-scene-lock="tablet"] .pw-shop-product-layout{grid-template-columns:minmax(0,.88fr) minmax(0,1.12fr);gap:18px}
html[data-pw-edit-device="tablet"] .pw-pdp-gallery-desktop,html[data-pw-scene-lock="tablet"] .pw-pdp-gallery-desktop{min-width:0;align-self:start}
html[data-pw-edit-device="tablet"] .pw-pdp-gallery-desktop .pw-shop-product-img,html[data-pw-edit-device="tablet"] .pw-pdp-gallery-desktop [data-pw-el="main-image"],html[data-pw-scene-lock="tablet"] .pw-pdp-gallery-desktop .pw-shop-product-img,html[data-pw-scene-lock="tablet"] .pw-pdp-gallery-desktop [data-pw-el="main-image"]{max-height:56vh;padding:8px;border:1px solid var(--pw-border);border-radius:14px;background:var(--pw-bg);box-sizing:border-box}
html[data-pw-edit-device="tablet"] .pw-shop-product-thumbs,html[data-pw-scene-lock="tablet"] .pw-shop-product-thumbs{flex-wrap:nowrap;overflow-x:auto;padding:2px 0 6px;scrollbar-width:none}
html[data-pw-edit-device="tablet"] .pw-shop-product-thumbs::-webkit-scrollbar,html[data-pw-scene-lock="tablet"] .pw-shop-product-thumbs::-webkit-scrollbar{display:none}
html[data-pw-edit-device="tablet"] .pw-shop-product-thumb,html[data-pw-scene-lock="tablet"] .pw-shop-product-thumb{flex:0 0 56px;width:56px;height:56px}
html[data-pw-edit-device="tablet"] .pw-shop-pdp-info,html[data-pw-scene-lock="tablet"] .pw-shop-pdp-info{min-width:0;padding:18px;border:1px solid var(--pw-border);border-radius:16px;background:var(--pw-bg);box-shadow:0 6px 20px rgba(15,23,42,.06)}
html[data-pw-edit-device="tablet"] .pw-pdp-title,html[data-pw-scene-lock="tablet"] .pw-pdp-title{font-size:1.15rem;line-height:1.4}
html[data-pw-edit-device="tablet"] .pw-pdp-price-card,html[data-pw-scene-lock="tablet"] .pw-pdp-price-card{margin-top:12px;padding:12px;border-radius:12px}
html[data-pw-edit-device="tablet"] .pw-pdp-actions-inline,html[data-pw-scene-lock="tablet"] .pw-pdp-actions-inline{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}
html[data-pw-edit-device="tablet"] .pw-pdp-actions-inline>.pw-shop-btn,html[data-pw-scene-lock="tablet"] .pw-pdp-actions-inline>.pw-shop-btn{width:100%;min-width:0;min-height:44px;padding:9px 8px;font-size:12px;white-space:normal}
html[data-pw-edit-device="tablet"] .pw-pdp-actions-inline>.pw-shop-btn:last-child,html[data-pw-scene-lock="tablet"] .pw-pdp-actions-inline>.pw-shop-btn:last-child{grid-column:1/-1}
html[data-pw-edit-device="tablet"] .pw-shop-product-detail,html[data-pw-scene-lock="tablet"] .pw-shop-product-detail{margin-top:28px;gap:24px}
html[data-pw-edit-device="tablet"] .pw-pdp-tabpanel,html[data-pw-scene-lock="tablet"] .pw-pdp-tabpanel{padding:14px}
html[data-pw-edit-device="laptop"] .pw-shop-product-layout,html[data-pw-scene-lock="laptop"] .pw-shop-product-layout{grid-template-columns:minmax(0,.94fr) minmax(0,1.06fr);gap:32px}
html[data-pw-edit-device="laptop"] .pw-pdp-gallery-desktop,html[data-pw-scene-lock="laptop"] .pw-pdp-gallery-desktop{position:sticky;top:calc(var(--pw-sticky-head,72px) + 16px);min-width:0;align-self:start}
html[data-pw-edit-device="laptop"] .pw-pdp-gallery-desktop .pw-shop-product-img,html[data-pw-edit-device="laptop"] .pw-pdp-gallery-desktop [data-pw-el="main-image"],html[data-pw-scene-lock="laptop"] .pw-pdp-gallery-desktop .pw-shop-product-img,html[data-pw-scene-lock="laptop"] .pw-pdp-gallery-desktop [data-pw-el="main-image"]{max-height:66vh;padding:12px;border:1px solid var(--pw-border);border-radius:16px;background:var(--pw-bg);box-sizing:border-box}
html[data-pw-edit-device="laptop"] .pw-shop-product-thumbs,html[data-pw-scene-lock="laptop"] .pw-shop-product-thumbs{flex-wrap:nowrap;overflow-x:auto;padding:2px 0 6px;scrollbar-width:none}
html[data-pw-edit-device="laptop"] .pw-shop-product-thumbs::-webkit-scrollbar,html[data-pw-scene-lock="laptop"] .pw-shop-product-thumbs::-webkit-scrollbar{display:none}
html[data-pw-edit-device="laptop"] .pw-shop-product-thumb,html[data-pw-scene-lock="laptop"] .pw-shop-product-thumb{flex:0 0 64px}
html[data-pw-edit-device="laptop"] .pw-shop-pdp-info,html[data-pw-scene-lock="laptop"] .pw-shop-pdp-info{min-width:0;padding:24px;border:1px solid var(--pw-border);border-radius:18px;background:var(--pw-bg);box-shadow:0 8px 28px rgba(15,23,42,.07)}
html[data-pw-edit-device="laptop"] .pw-pdp-title,html[data-pw-scene-lock="laptop"] .pw-pdp-title{font-size:1.35rem;line-height:1.35}
html[data-pw-edit-device="laptop"] .pw-pdp-price-card,html[data-pw-scene-lock="laptop"] .pw-pdp-price-card{padding:16px}
html[data-pw-edit-device="laptop"] .pw-pdp-actions-inline,html[data-pw-scene-lock="laptop"] .pw-pdp-actions-inline{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}
html[data-pw-edit-device="laptop"] .pw-pdp-actions-inline>.pw-shop-btn,html[data-pw-scene-lock="laptop"] .pw-pdp-actions-inline>.pw-shop-btn{width:100%;min-width:0;min-height:46px;padding:10px 12px;white-space:normal}
html[data-pw-edit-device="laptop"] .pw-pdp-actions-inline>.pw-shop-btn:last-child,html[data-pw-scene-lock="laptop"] .pw-pdp-actions-inline>.pw-shop-btn:last-child{grid-column:1/-1}
html[data-pw-edit-device="laptop"] .pw-shop-product-detail,html[data-pw-scene-lock="laptop"] .pw-shop-product-detail{margin-top:36px;gap:28px}
@media ${pwUnlockedTabletMediaQuery()}{html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-layout{grid-template-columns:minmax(0,.88fr) minmax(0,1.12fr);gap:18px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-gallery-desktop .pw-shop-product-img,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-gallery-desktop [data-pw-el="main-image"]{max-height:56vh;padding:8px;border:1px solid var(--pw-border);border-radius:14px;background:var(--pw-bg);box-sizing:border-box}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-pdp-info{min-width:0;padding:18px;border:1px solid var(--pw-border);border-radius:16px;background:var(--pw-bg);box-shadow:0 6px 20px rgba(15,23,42,.06)}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-actions-inline{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-actions-inline>.pw-shop-btn{width:100%;min-width:0;min-height:44px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-actions-inline>.pw-shop-btn:last-child{grid-column:1/-1}}
@media(min-width:1280px) and (max-width:1439px){html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-layout{grid-template-columns:minmax(0,.94fr) minmax(0,1.06fr);gap:32px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-gallery-desktop{position:sticky;top:calc(var(--pw-sticky-head,72px) + 16px);align-self:start}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-gallery-desktop .pw-shop-product-img,html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-gallery-desktop [data-pw-el="main-image"]{max-height:66vh;padding:12px;border:1px solid var(--pw-border);border-radius:16px;background:var(--pw-bg);box-sizing:border-box}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-pdp-info{min-width:0;padding:24px;border:1px solid var(--pw-border);border-radius:18px;background:var(--pw-bg);box-shadow:0 8px 28px rgba(15,23,42,.07)}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-actions-inline{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-actions-inline>.pw-shop-btn{width:100%;min-width:0;min-height:46px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-actions-inline>.pw-shop-btn:last-child{grid-column:1/-1}}
@media ${pwUnlockedTabletMediaQuery()}{html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-thumbs{flex-wrap:nowrap;overflow-x:auto;padding:2px 0 6px;scrollbar-width:none}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-thumbs::-webkit-scrollbar{display:none}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-thumb{flex:0 0 56px;width:56px;height:56px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-title{font-size:1.15rem;line-height:1.4}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-price-card{margin-top:12px;padding:12px;border-radius:12px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-detail{margin-top:28px;gap:24px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-tabpanel{padding:14px}}
@media(min-width:1280px) and (max-width:1439px){html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-thumbs{flex-wrap:nowrap;overflow-x:auto;padding:2px 0 6px;scrollbar-width:none}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-thumbs::-webkit-scrollbar{display:none}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-thumb{flex:0 0 64px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-title{font-size:1.35rem;line-height:1.35}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-pdp-price-card{padding:16px}html:not([data-pw-edit-device]):not([data-pw-scene-lock]) .pw-shop-product-detail{margin-top:36px;gap:28px}}
.pw-shop-pdp-info>[data-pw-pdp-option]{margin-top:10px!important}
.pw-shop-pdp-info>[data-pw-pdp-option]>p{margin:0 0 6px!important;font-size:12px!important;line-height:1.3}
...
.pw-shop-pdp-info>div:has(>.pw-pdp-qty)>p{margin:0!important;font-size:12px!important}
.pw-shop-pdp-info .pw-pdp-qty{gap:5px}
...
.pw-pdp-sticky-nav svg{width:17px!important;height:17px!important;max-width:17px!important;max-height:17px!important;display:block!important;margin:0 auto!important;flex-shrink:0!important;align-self:center!important}
.pw-pdp-sticky-nav .pw-chrome-icon-wrap{display:flex!important;align-items:center!important;justify-content:center!important;width:17px!important;height:17px!important;max-width:17px!important;max-height:17px!important;margin:0 auto!important;flex-shrink:0!important}
.pw-pdp-sticky-copy,.pw-pdp-like-copy{display:flex;flex-direction:column;align-items:center;justify-content:flex-start;width:100%;max-width:100%;gap:0;line-height:1.1;text-align:center}
.pw-pdp-sticky-copy>span,.pw-pdp-like-copy>span{display:block;width:100%;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:10px;line-height:1.1}
...
@media(max-width:767px){
  ...
  .pw-pdp-sticky-nav svg{width:17px;height:17px;max-width:17px;max-height:17px;display:block;margin:0 auto;flex-shrink:0}
  .pw-pdp-sticky-ctas{flex:1;min-width:0;display:flex;gap:4px;align-items:stretch}
  .pw-pdp-sticky-ctas .pw-shop-btn{flex:1;padding:0 8px;min-height:44px;font-size:11px;font-weight:600;line-height:1.15;text-transform:uppercase;border-radius:6px;color:#fff}
}
@media(min-width:768px){
  ...
  .pw-pdp-sticky.is-visible .pw-pdp-sticky-nav button.is-fav[aria-pressed="true"],.pw-pdp-sticky.is-visible .pw-pdp-sticky-nav button.is-fav.is-active{color:var(--pw-primary)}
  .pw-pdp-sticky.is-visible .pw-pdp-sticky-nav button.is-fav[aria-pressed="true"] svg,.pw-pdp-sticky.is-visible .pw-pdp-sticky-nav button.is-fav.is-active svg{fill:currentColor;stroke:currentColor}
  ...
  .pw-pdp-sticky.is-visible .pw-pdp-sticky-ctas{display:flex;align-items:stretch;gap:8px}
  .pw-pdp-sticky.is-visible .pw-pdp-sticky-ctas .pw-shop-btn{min-width:160px;min-height:48px;padding:12px 20px;font-size:14px;line-height:1.2;font-weight:600;text-transform:uppercase;border-radius:8px;color:#fff;box-sizing:border-box}
}
@media(min-width:1280px){
...
html[data-pw-edit-device="mobile"] .pw-pdp-hero,html[data-pw-scene-lock="mobile"] .pw-pdp-hero,[data-pw-visual-device="mobile"] .pw-pdp-hero{display:grid;grid-template-columns:minmax(0,1fr);width:calc(100% + 2 * var(--pw-page-gutter,4px));max-width:none;margin-inline:calc(-1 * var(--pw-page-gutter,4px));padding-inline:0;box-sizing:border-box;scroll-margin-top:calc(var(--pw-sticky-head,56px) + 4px)}
...
.pw-shop-cart-layout{display:grid;gap:20px;min-width:0;max-width:100%;width:100%}
@media(min-width:1280px){.pw-shop-cart-layout{grid-template-columns:minmax(0,1fr) minmax(320px,400px);align-items:start}}
.pw-shop-cart,.pw-shop-cart-list,.pw-shop-cart-summary{min-width:0;max-width:100%}
.pw-shop-cart{overflow-x:visible;max-width:100%}
.pw-shop-cart-select-all{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:10px;padding:10px 12px;border:1px solid var(--pw-border);border-radius:10px;background:var(--pw-surface);min-width:0;flex-wrap:wrap}
...
.pw-shop-cart-row{display:grid;gap:10px;padding:12px;border:1px solid var(--pw-border);border-radius:12px;background:var(--pw-bg);grid-template-columns:22px 64px minmax(0,1fr);align-items:start;box-shadow:0 1px 4px rgba(15,23,42,.04);min-width:0;max-width:100%;box-sizing:border-box}
...
.pw-shop-cart-line-total{margin:0;font-weight:800;color:var(--pw-buy);white-space:normal;overflow-wrap:anywhere;font-size:14px}
.pw-shop-cart-summary{background:var(--pw-bg);border:1px solid var(--pw-border,#e5e7eb);border-radius:12px;padding:16px;display:grid;gap:10px;box-shadow:0 1px 4px rgba(15,23,42,.04);min-width:0;max-width:100%;box-sizing:border-box;overflow:visible}
@media(min-width:1280px){.pw-shop-cart-summary{position:sticky;top:calc(var(--pw-sticky-head,72px) + 12px)}}
.pw-shop-cart-discount-breakdown{display:grid;gap:6px;padding:10px 0;border-block:1px solid var(--pw-border);min-width:0;max-width:100%}
.pw-shop-cart-discount-breakdown p{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;margin:0;font-size:13px;align-items:baseline;min-width:0}
.pw-shop-cart-discount-breakdown p span{min-width:0;overflow-wrap:anywhere}
.pw-shop-cart-discount-breakdown p strong{text-align:right;white-space:normal;overflow-wrap:anywhere;font-variant-numeric:tabular-nums}
.pw-shop-cart-discount-breakdown p:not(.is-clearance):not(.pw-shop-cart-cap-meter):not(.pw-shop-cart-promo-msg):not(.pw-shop-cart-section):not(.pw-shop-cart-saved) strong{color:var(--pw-buy)}
.pw-shop-cart-discount-breakdown .is-clearance{padding:8px;border-radius:8px;background:#fffbeb;border:1px solid #fde68a;display:grid;gap:6px}
.pw-shop-cart-discount-breakdown .pw-shop-cart-section{display:block;font-size:11px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:#6b7280}
.pw-shop-cart-discount-breakdown .is-list strong{color:#9ca3af;font-weight:500;text-decoration:line-through}
.pw-shop-cart-discount-breakdown .is-flash span{color:#e11d48}
.pw-shop-cart-discount-breakdown .is-calendar span{color:#dc2626}
.pw-shop-cart-discount-breakdown .is-birthday span,.pw-shop-cart-discount-breakdown .is-birthday strong{color:#db2777}
.pw-shop-cart-discount-breakdown .is-loyalty span{color:#2563eb}
.pw-shop-cart-discount-breakdown .is-google span{color:#059669}
.pw-shop-cart-discount-breakdown .is-voucher span{color:#047857}
.pw-shop-cart-saved{color:#047857;font-size:12px!important;font-weight:600}
...
.pw-shop-cart-line-chips{display:flex;flex-wrap:wrap;gap:4px;margin:6px 0 4px}
.pw-shop-cart-chip{display:inline-flex;align-items:center;padding:2px 6px;border-radius:4px;color:#fff;font-size:10px;font-weight:800;letter-spacing:.02em}
.pw-shop-cart-chip-flash{background:#e11d48}
.pw-shop-cart-chip-calendar{background:#dc2626}
.pw-shop-cart-chip-teaser{background:#f59e0b}
.pw-shop-cart-chip-clearance{background:#b45309}
.pw-shop-cart-chip-google{background:#059669}
.pw-shop-cart-chip-birthday{background:#db2777}
.pw-shop-cart-kicker{display:block;font-size:10px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:#6b7280}
.pw-shop-cart-line-expected{margin:2px 0 0;font-size:12px;font-weight:700;color:#047857}
.pw-shop-cart-line-save{margin:2px 0 0;font-size:11px;font-weight:600;color:#059669}
.pw-shop-cart-line-save.is-teaser{color:#b45309}
.pw-shop-cart-line-save.is-birthday{color:#db2777}
.pw-shop-cart-birthday{margin:6px 0 0}
.pw-shop-cart-birthday-count,.pw-shop-cart-line-count.pw-shop-cart-birthday-count{color:#9d174d}
.pw-shop-cart-line-count{margin:4px 0 0;font-size:11px;font-weight:600;color:#92400e}
.pw-shop-cart-line-total-wrap{min-width:0;text-align:right}
.pw-shop-cart-line-compare{margin:0;font-size:12px;color:#9ca3af;text-decoration:line-through}
...
.pw-shop-cart-promo-row{display:flex;flex-direction:column;gap:8px;align-items:stretch;width:100%;min-width:0}
.pw-shop-cart-promo-row input{min-width:0;width:100%;padding:8px 10px;border:1px solid #d1d5db;border-radius:8px;font:inherit;font-size:14px}
.pw-shop-cart-promo-row .pw-shop-btn{width:100%;white-space:normal;flex-shrink:0}
.pw-shop-cart-promo-msg{margin:6px 0 0;font-size:13px;line-height:1.45}
.pw-shop-cart-promo-msg.is-error{color:#b91c1c;font-weight:600}
.pw-shop-cart-promo-msg.is-warn{color:#b45309;font-weight:600}
.pw-shop-cart-grand{margin:0;font-weight:800;font-size:16px;overflow-wrap:anywhere}
...
.pw-shop-cart-actions{display:flex;flex-direction:column;gap:8px;margin-top:4px;width:100%;min-width:0}
.pw-shop-cart-actions .pw-shop-btn{width:100%;flex:none;white-space:normal}
.pw-shop-cart-summary .pw-shop-form{max-width:none;margin-top:8px;width:100%}
.pw-shop-cart-summary .pw-shop-form input:not([type="checkbox"]):not([type="radio"]),.pw-shop-cart-summary .pw-shop-form textarea,.pw-shop-cart-summary .pw-shop-form select{min-height:44px;padding:12px 14px;font-size:16px;border-radius:10px;width:100%;max-width:100%;box-sizing:border-box}
.pw-shop-cart-summary .pw-shop-form textarea{min-height:5.5rem}
${PW_SHOP_CART_COMPACT_LAYOUT_CSS}
@media(max-width:899px){html:not([data-pw-edit-device]):not([data-pw-scene-lock]){${PW_SHOP_DEPOSIT_COMPACT_LAYOUT_CSS}}}
html[data-pw-edit-device="mobile"],html[data-pw-scene-lock="mobile"],html[data-pw-edit-device="tablet"],html[data-pw-scene-lock="tablet"]{${PW_SHOP_DEPOSIT_COMPACT_LAYOUT_CSS}}
html[data-pw-edit-device="tablet"] .pw-shop-account-content:has(.pw-shop-deposit),html[data-pw-scene-lock="tablet"] .pw-shop-account-content:has(.pw-shop-deposit){padding:12px!important}
html[data-pw-edit-device="tablet"] .pw-shop-deposit,html[data-pw-scene-lock="tablet"] .pw-shop-deposit{border:1px solid var(--pw-border,#e5e7eb);border-radius:14px}
html[data-pw-edit-device="tablet"] .pw-shop-deposit-head,html[data-pw-scene-lock="tablet"] .pw-shop-deposit-head{padding:14px 16px}
html[data-pw-edit-device="tablet"] .pw-shop-deposit-pay,html[data-pw-edit-device="tablet"] .pw-shop-deposit-info,html[data-pw-edit-device="tablet"] .pw-shop-deposit-col,html[data-pw-scene-lock="tablet"] .pw-shop-deposit-pay,html[data-pw-scene-lock="tablet"] .pw-shop-deposit-info,html[data-pw-scene-lock="tablet"] .pw-shop-deposit-col{padding:16px}
html[data-pw-edit-device="tablet"] .pw-shop-deposit-qr img,html[data-pw-scene-lock="tablet"] .pw-shop-deposit-qr img{width:min(360px,100%)}
html[data-pw-edit-device="tablet"] .pw-shop-deposit-opts,html[data-pw-scene-lock="tablet"] .pw-shop-deposit-opts{flex-direction:row;flex-wrap:wrap}
...
.pw-shop-form input:not([type="checkbox"]):not([type="radio"]),.pw-shop-form textarea,.pw-shop-form select{padding:11px 12px;border:1px solid #9ca3af;border-radius:8px;font:inherit;font-size:15px;line-height:1.4;color:var(--pw-text);background:#fff}
...
.pw-shop-footer-hint{margin:0;max-width:100%;font-size:13px;line-height:1.65;color:inherit;opacity:.78}
.pw-shop-footer-hint[data-pw-el="slogan"]{max-width:100%;white-space:normal;overflow:visible}
...
${PW_SHOP_ACCOUNT_COMMERCE_POLISH_CSS}
