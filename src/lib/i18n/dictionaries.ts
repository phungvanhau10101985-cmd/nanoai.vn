...
const VI_DICTIONARY: Dictionary = {
  ...
  partnerMessagingOrders: {
    ...
    confirmDepositBody: 'Đơn {code}. Số tiền cọc: {amount}',
    confirmDepositNoTxn: 'Chưa có giao dịch cọc.',
    confirmDepositManualHint: 'Nếu khách đã chuyển khoản, bấm «Xác nhận cọc» bên dưới.',
...
const EN_DICTIONARY: Dictionary = {
  ...
  partnerMessagingOrders: {
    ...
    revenueModeYear: 'By year',
    revenueModeRange: 'Date range',
    revenuePickDay: 'Pick a date',
    revenueToday: 'Today',
    revenueThisWeek: 'This week',
    revenueLastWeek: 'Last week',
    revenueThisMonth: 'This month',
    revenueLastMonth: 'Last month',
    revenuePickMonth: 'Pick a month',
    revenueViewMonth: 'View month',
    revenueYear: 'Year',
    revenueViewYear: 'View year',
    revenueViewRange: 'View range',
    revenuePeriod: 'Report period',
    revenueAmount: 'Revenue',
    revenueOrderCount: 'Orders',
    revenueCancelledReturned: '{cancelled} cancelled · {returned} returned',
    revenueLoading: 'Loading report…',
    revenuePickPeriod: 'Choose a period to view the report.',
    revenueNeedDay: 'Pick a date or tap «Today».',
    revenueNeedWeek: 'Choose «This week» or «Last week».',
    revenueNeedMonth: 'Pick a month or tap «This month» / «Last month».',
    revenueNeedYear: 'Invalid year.',
    revenueNeedRange: 'Pick at least a start date.',
    revenueInvalidMonth: 'Invalid month.',
    revenueInvalidYear: 'Invalid year.',
    revenueLoadError: 'Could not load the revenue report',
    tabReturned: 'Returned to shop',
    tableColDeposit: 'Deposit',
    tableColPayment: 'Payment',
    depositNeed: 'Due',
    depositPaid: 'Paid',
    depositNotRequired: 'No deposit required',
    pageSize25: '25 / page',
    pageSize50: '50 / page',
    pageSize100: '100 / page',
    pageSizeAria: 'Orders per page',
    paginationSummary: 'Showing {from}–{to} / {total} orders · Page {page} / {pages}',
    paginationSearchHint: ' · search «{q}»',
    ...
    confirmDepositBody: 'Order {code}. Deposit: {amount}',
    confirmDepositNoTxn: 'No deposit transaction yet.',
    confirmDepositManualHint: 'If the customer already transferred, tap «Confirm deposit» below.',
    confirmDepositNoteLabel: 'Note',
    confirmDepositNotePlaceholder: 'Note...',
    btnRejectDeposit: 'Reject deposit',
    btnConfirmDepositReceived: 'Confirm deposit received',
    btnCancelModal: 'Cancel',
    btnMarkShipping: 'Mark as shipping (manual)',
    btnComplete: 'Complete',
    btnApproveReturn: 'Confirm return received at shop',
    btnRefundDeposit: 'Approve deposit refund',
    btnClose: 'Close',
    noAddress: 'No address yet',
    customerCodeLabel: 'Order code (customer-facing)',
    internalIdLabel: 'Internal ID: #{id}',
    paymentWhenReceive: 'Amount due on delivery',
    colQty: 'Qty',
  ...
  partnerMessagingMarketing: {
    ...
    audienceHint: 'Preset: widget chat within the last 90 days (or has an order) and has an email.',
    segmentPresetLabel: 'Preset',
    segmentChat90d: 'Chatted within 90 days · has email',
    recipientCount: '{count} eligible customers with email',
    ...
    noRecipients: 'No eligible customers with email in this segment.',
  ...
  partnerGuestChat: {
    ...
    photoAngleDetailTemplateMessage:
      'For the specific photo angle you asked about, please tap "View details" on the product card below to see full images and details on the web page.',
...
const ZH_DICTIONARY: Dictionary = {
  ...
  partnerMessagingOrders: {
    ...
    revenueThisMonth: '本月',
    revenueLastMonth: '上月',
    revenuePickMonth: '选择月份',
    revenueViewMonth: '查看月份',
    revenueYear: '年份',
    revenueViewYear: '按年查看',
    revenueViewRange: '查看区间',
    revenuePeriod: '报表周期',
    revenueAmount: '营收',
    revenueOrderCount: '订单数',
    revenueCancelledReturned: '{cancelled} 取消 · {returned} 退货',
    revenueLoading: '正在加载报表…',
    revenuePickPeriod: '请选择周期以查看报表。',
    revenueNeedDay: '请选择日期或点「今天」。',
    revenueNeedWeek: '请选择「本周」或「上周」。',
    revenueNeedMonth: '请选择月份或点「本月」/「上月」。',
    revenueNeedYear: '年份无效。',
    revenueNeedRange: '请至少选择开始日期。',
    revenueInvalidMonth: '月份无效。',
    revenueInvalidYear: '年份无效。',
    revenueLoadError: '无法加载营收报表',
    tabReturned: '退货已回店',
    tableColDeposit: '定金',
    tableColPayment: '付款',
    depositNeed: '应付',
    depositPaid: '已付',
    depositNotRequired: '无需定金',
    pageSize25: '25 / 页',
    pageSize50: '50 / 页',
    pageSize100: '100 / 页',
    pageSizeAria: '每页订单数',
    paginationSummary: '显示 {from}–{to} / {total} 单 · 第 {page} / {pages} 页',
    paginationSearchHint: ' · 搜索「{q}」',
    paginationFirst: '首页',
    paginationPrev: '上一页',
    paginationNext: '下一页',
    paginationLast: '末页',
    ...
    confirmDepositBody: '订单 {code}。定金：{amount}',
    confirmDepositNoTxn: '尚无定金交易。',
    confirmDepositManualHint: '如顾客已转账，请点击下方「确认定金」。',
    confirmDepositNoteLabel: '备注',
    confirmDepositNotePlaceholder: '备注...',
    btnRejectDeposit: '拒绝定金',
    btnConfirmDepositReceived: '确认已收到定金',
    btnCancelModal: '取消',
    btnMarkShipping: '标记配送中（手动）',
    btnComplete: '完成',
    btnApproveReturn: '确认退货已回店',
    btnRefundDeposit: '批准退定金',
    btnClose: '关闭',
    noAddress: '暂无地址',
    customerCodeLabel: '订单号（顾客可见）',
    internalIdLabel: '内部 ID：#{id}',
    paymentWhenReceive: '货到应付金额',
    colQty: '数量',
    colUnitPrice: '单价',
    colLineTotal: '小计',
    skuLabel: 'SKU：{sku}',
  ...
  partnerMessagingMarketing: {
    ...
    stepAudience: '1. 受众',
    audienceHint: '预设：最近90天内有小组件聊天记录（或有过订单）且留有邮箱。',
    segmentPresetLabel: '预设',
    segmentChat90d: '90天内聊过 · 有邮箱',
    recipientCount: '有邮箱且符合条件：{count} 人',
    loadingCount: '统计中…',
    refreshPreview: '刷新预览',
    stepContent: '2. 内容',
    ...
    noRecipients: '该受众中没有留有邮箱的符合条件客户。',
    draftSaved: '草稿已保存。',
    cancelled: '活动已取消。',
  ...
  partnerGuestChat: {
    ...
    photoAngleDetailTemplateMessage:
      '您询问的是特定角度图片，请点击下方商品卡片的“查看详情”，在网页里查看完整图片和商品细节。',
...
const JA_DICTIONARY: Dictionary = {
  ...
  partnerMessagingOrders: {
    ...
    revenueModeMonth: '月別',
    revenueModeYear: '年別',
    revenueModeRange: '期間指定',
    revenuePickDay: '日付を選択',
    revenueToday: '今日',
    revenueThisWeek: '今週',
    revenueLastWeek: '先週',
    revenueThisMonth: '今月',
    revenueLastMonth: '先月',
    revenuePickMonth: '月を選択',
    revenueViewMonth: '月を表示',
    revenueYear: '年',
    revenueViewYear: '年で表示',
    revenueViewRange: '期間を表示',
    revenuePeriod: '対象期間',
    revenueAmount: '売上',
    revenueOrderCount: '注文件数',
    revenueCancelledReturned: '{cancelled} キャンセル · {returned} 返品',
    revenueLoading: 'レポートを読み込み中…',
    revenuePickPeriod: '期間を選んでレポートを表示します。',
    revenueNeedDay: '日付を選ぶか「今日」を押してください。',
    revenueNeedWeek: '「今週」または「先週」を選んでください。',
    revenueNeedMonth: '月を選ぶか「今月」/「先月」を押してください。',
    revenueNeedYear: '年が無効です。',
    revenueNeedRange: '開始日を選んでください。',
    revenueInvalidMonth: '月が無効です。',
    revenueInvalidYear: '年が無効です。',
    revenueLoadError: '売上レポートを読み込めませんでした',
    tabReturned: '返品が店舗に到着',
    tableColDeposit: 'デポジット',
    tableColPayment: '支払い',
    depositNeed: '必要額',
    depositPaid: '入金済',
    depositNotRequired: 'デポジット不要',
    pageSize25: '25 / ページ',
    pageSize50: '50 / ページ',
    pageSize100: '100 / ページ',
    pageSizeAria: '1ページあたりの件数',
    paginationSummary: '{from}–{to} / {total} 件 · {page} / {pages} ページ',
    paginationSearchHint: ' · 検索「{q}」',
    paginationFirst: '先頭',
    paginationPrev: '前',
    paginationNext: '次',
    paginationLast: '末尾',
    ...
    confirmDepositBody: '注文 {code}。デポジット：{amount}',
    confirmDepositNoTxn: 'デポジット取引はまだありません。',
    confirmDepositManualHint: '入金済みなら下の「デポジット確認」を押してください。',
    confirmDepositNoteLabel: 'メモ',
    confirmDepositNotePlaceholder: 'メモ...',
    btnRejectDeposit: 'デポジット拒否',
    btnConfirmDepositReceived: 'デポジット受領を確認',
    btnCancelModal: 'キャンセル',
    btnMarkShipping: '配送中にする（手動）',
    btnComplete: '完了',
    btnApproveReturn: '返品到着を確認',
    btnRefundDeposit: 'デポジット返金を承認',
    btnClose: '閉じる',
    noAddress: '住所未登録',
    customerCodeLabel: '注文コード（お客様向け）',
    internalIdLabel: '内部 ID: #{id}',
    paymentWhenReceive: '受取時の支払い額',
    colQty: '数量',
    colUnitPrice: '単価',
    colLineTotal: '小計',
    skuLabel: 'SKU: {sku}',
  ...
  partnerMessagingMarketing: {
    ...
    stepAudience: '1. 対象',
    audienceHint: 'プリセット：過去90日以内にウィジェットでチャット（または注文あり）かつメールあり。',
    segmentPresetLabel: 'プリセット',
    segmentChat90d: '90日以内にチャット · メールあり',
    recipientCount: 'メールあり対象 {count} 人',
    loadingCount: '集計中…',
    ...
    noRecipients: '対象にメールがあるお客様がいません。',
  ...
  partnerGuestChat: {
    ...
    photoAngleDetailTemplateMessage:
      'ご希望の具体的な角度写真は、下の商品カードの「詳細を見る」を押して、Webページで画像と詳細をご確認ください。',
...
const KO_DICTIONARY: Dictionary = {
  ...
  partnerMessagingOrders: {
    ...
    revenueModeYear: '연별',
    revenueModeRange: '기간',
    revenuePickDay: '날짜 선택',
    revenueToday: '오늘',
    revenueThisWeek: '이번 주',
    revenueLastWeek: '지난 주',
    revenueThisMonth: '이번 달',
    revenueLastMonth: '지난 달',
    revenuePickMonth: '월 선택',
    revenueViewMonth: '월 보기',
    revenueYear: '연도',
    revenueViewYear: '연도별 보기',
    revenueViewRange: '기간 보기',
    revenuePeriod: '보고 기간',
    revenueAmount: '매출',
    revenueOrderCount: '주문 수',
    revenueCancelledReturned: '{cancelled} 취소 · {returned} 반품',
    revenueLoading: '보고서 불러오는 중…',
    revenuePickPeriod: '기간을 선택해 보고서를 보세요.',
    revenueNeedDay: '날짜를 고르거나 «오늘»을 누르세요.',
    revenueNeedWeek: '«이번 주» 또는 «지난 주»를 선택하세요.',
    revenueNeedMonth: '월을 고르거나 «이번 달» / «지난 달»을 누르세요.',
    revenueNeedYear: '연도가 올바르지 않습니다.',
    revenueNeedRange: '시작일을 선택하세요.',
    revenueInvalidMonth: '월이 올바르지 않습니다.',
    revenueInvalidYear: '연도가 올바르지 않습니다.',
    revenueLoadError: '매출 보고서를 불러오지 못했습니다',
    tabReturned: '반품 매장 도착',
    tableColDeposit: '계약금',
    tableColPayment: '결제',
    depositNeed: '필요',
    depositPaid: '입금됨',
    depositNotRequired: '계약금 없음',
    pageSize25: '25 / 페이지',
    pageSize50: '50 / 페이지',
    pageSize100: '100 / 페이지',
    pageSizeAria: '페이지당 주문 수',
    paginationSummary: '{from}–{to} / {total}건 · {page} / {pages}페이지',
    paginationSearchHint: ' · 검색 «{q}»',
    paginationFirst: '처음',
    paginationPrev: '이전',
    paginationNext: '다음',
    paginationLast: '마지막',
    ...
    confirmDepositBody: '주문 {code}. 계약금: {amount}',
    confirmDepositNoTxn: '계약금 거래가 없습니다.',
    confirmDepositManualHint: '고객이 이미 이체했다면 아래 «계약금 확인»을 누르세요.',
    confirmDepositNoteLabel: '메모',
    confirmDepositNotePlaceholder: '메모...',
    btnRejectDeposit: '계약금 거절',
    btnConfirmDepositReceived: '계약금 수령 확인',
    btnCancelModal: '취소',
    btnMarkShipping: '배송 중으로 변경(수동)',
    btnComplete: '완료',
    btnApproveReturn: '반품 매장 도착 확인',
    btnRefundDeposit: '계약금 환불 승인',
    btnClose: '닫기',
    noAddress: '주소 없음',
    customerCodeLabel: '주문 코드(고객 표시)',
    internalIdLabel: '내부 ID: #{id}',
    paymentWhenReceive: '수령 시 결제 금액',
    colQty: '수량',
    colUnitPrice: '단가',
    colLineTotal: '합계',
    skuLabel: 'SKU: {sku}',
  ...
  partnerMessagingMarketing: {
    ...
    stepAudience: '1. 대상',
    audienceHint: '프리셋: 최근 90일 내 위젯 채팅(또는 주문 있음) 및 이메일 보유.',
    segmentPresetLabel: '프리셋',
    segmentChat90d: '90일 내 채팅 · 이메일 있음',
    recipientCount: '이메일 있는 대상 {count}명',
    loadingCount: '집계 중…',
    ...
    noRecipients: '이메일이 있는 해당 고객이 없습니다.',
  ...
  partnerGuestChat: {
    ...
    photoAngleDetailTemplateMessage:
      '요청하신 특정 각도 사진은 아래 상품 카드의 "자세히 보기"를 눌러 웹 페이지에서 상세 이미지와 정보를 확인해 주세요.',
