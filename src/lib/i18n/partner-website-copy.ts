...
const COPY: Record<WebLocale, PartnerWebsiteCopy> = {
  vi: {
    ...
    visualEditSelectHint: 'Bấm chữ/ảnh/nút · Kéo để đổi vị trí · Bấm vùng trống để chọn khối',
    ...
    visualEditNudgeHint: 'Kéo icon di chuyển ở góc khối, hoặc dùng phím mũi tên',
    ...
    setupStep3Hint: 'Bấm Sửa nhanh bên phải, rồi lưu.',
  ...
  en: {
    ...
    visualEditSelectHint: 'Click text/image/button · Drag to move · Click empty area to select a block',
    ...
    visualEditNudgeHint: 'Drag the move icon on the block corner, or use arrow keys',
    ...
    setupStep3Hint: 'Use Quick edit on the right, then save.',
  ...
  zh: {
    ...
    visualEditSelectHint: '点击文字/图片/按钮 · 拖动移动 · 点击空白选区块',
  ...
  ja: {
    ...
    visualEditSelectHint: '文字/画像/ボタンをクリック · ドラッグで移動 · 空白クリックでブロック選択',
  ...
  ko: {
    ...
    visualEditSelectHint: '텍스트/이미지/버튼 클릭 · 드래그로 이동 · 빈 곳 클릭해 블록 선택',
