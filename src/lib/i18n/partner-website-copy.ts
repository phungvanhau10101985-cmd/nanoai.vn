...
const COPY: Record<WebLocale, PartnerWebsiteCopy> = {
  vi: {
    ...
    visualEditSelectHint: 'Bấm chữ/nút để sửa · Trên banner bấm Khối hoặc Ảnh · Kéo icon để chuyển',
    previewPageLabel: 'Trang',
    visualEditAllPagesHint: 'Chọn trang và máy (Mobile/Desktop), rồi Sửa nhanh — hai bản lưu riêng, có thể khác nhau.',
    visualEditDeviceDesktop: 'Đang sửa bản Desktop',
    visualEditDeviceMobile: 'Đang sửa bản Mobile',
    visualEditDeviceHint: 'Mobile và Desktop lưu riêng. Sửa trên máy nào thì chỉ đổi bản đó.',
    ...
    visualEditLogoHint: 'Sửa prompt và gửi ảnh tham khảo nếu có. Nền/kích thước chỗ này đã được điền sẵn. Sửa hoặc tạo lại chỉ lưu vị trí đang chọn.',
    visualEditLogoPromptLabel: 'Prompt logo',
    visualEditLogoPromptPlaceholder: 'Ví dụ: chữ 188.com.vn, tối giản, không khung, nền trắng…',
    ...
    visualEditLogoCropX: 'Cắt ngang',
    visualEditLogoCropY: 'Cắt dọc',
    visualEditAddWidget: 'Thêm',
    visualEditAddLogo: 'Thêm logo',
    visualEditAddLogoHint: 'Kéo chuột để vẽ khung chữ nhật — logo sẽ đúng tỷ lệ và vị trí khung, nền lấy màu xung quanh.',
    ...
    setupChangeTemplateConfirm:
      'Đổi giao diện sẽ ghi đè mọi trang đã chỉnh Sửa nhanh. Sản phẩm và giỏ hàng (dữ liệu) giữ nguyên. Tiếp tục?',
  ...
  en: {
    ...
    visualEditSelectHint: 'Click text/buttons · On a banner tap Block or Image · Drag the move icon',
    previewPageLabel: 'Page',
    visualEditAllPagesHint: 'Pick a page and device (Mobile/Desktop), then Quick edit — each layout is saved separately.',
    visualEditDeviceDesktop: 'Editing desktop layout',
    visualEditDeviceMobile: 'Editing mobile layout',
    visualEditDeviceHint: 'Mobile and desktop are saved separately. Edits apply only to the device you are on.',
    ...
    visualEditLogoHint: 'Edit the prompt and add a reference image if you have one. Background and size are prefilled. Edit or regenerate saves only this slot.',
    visualEditLogoPromptLabel: 'Logo prompt',
    visualEditLogoPromptPlaceholder: 'e.g. 188.com.vn wordmark, minimal, no frame, white background…',
    ...
    visualEditLogoCropX: 'Crop X',
    visualEditLogoCropY: 'Crop Y',
    visualEditAddWidget: 'Add',
    visualEditAddLogo: 'Add logo',
    visualEditAddLogoHint: 'Drag to draw a rectangle — the logo matches that frame and uses the surrounding background.',
    ...
    setupChangeTemplateConfirm:
      'Changing the template overwrites every page edited with Quick edit. Product and cart data stay. Continue?',
  ...
  zh: {
    ...
    visualEditSelectHint: '点击文字/按钮 · 横幅上点「区块」或「图片」 · 拖动移动图标',
    previewPageLabel: '页面',
    visualEditAllPagesHint: '选择页面和设备（手机/桌面）再快速编辑 — 两套布局分开保存，可以不同。',
    visualEditDeviceDesktop: '正在编辑桌面版',
    visualEditDeviceMobile: '正在编辑手机版',
    visualEditDeviceHint: '手机版和桌面版分开保存。在哪个设备上编辑，只改那一套。',
    ...
    visualEditLogoHint: '可修改提示词并上传参考图。背景和尺寸已预填。编辑或重新生成只保存当前位置。',
    visualEditLogoPromptLabel: '标志提示词',
    visualEditLogoPromptPlaceholder: '例如：188.com.vn 文字标志，极简，无边框，白底…',
    visualEditLogoReferenceLabel: '参考图',
    visualEditLogoReferenceHint: '上传样例标志供 AI 参考。',
    visualEditRemoveReference: '删除参考图',
    visualEditLogoCropX: '水平裁剪',
    visualEditLogoCropY: '垂直裁剪',
    visualEditAddWidget: '添加',
    visualEditAddLogo: '添加标志',
    visualEditAddLogoHint: '拖动绘制矩形 — 标志按该框比例放在该位置，并使用周围背景色。',
    ...
    setupChangeTemplateConfirm:
      '更换模板会覆盖所有已用快速编辑改过的页面。商品与购物车数据保留。继续？',
  ...
  ja: {
    ...
    visualEditSelectHint: '文字/ボタンをクリック · バナーは「ブロック」か「画像」 · 移動アイコンをドラッグ',
    previewPageLabel: 'ページ',
    visualEditAllPagesHint: 'ページと端末（モバイル/デスクトップ）を選んでクイック編集 — レイアウトは別々に保存できます。',
    visualEditDeviceDesktop: 'デスクトップ版を編集中',
    visualEditDeviceMobile: 'モバイル版を編集中',
    visualEditDeviceHint: 'モバイルとデスクトップは別保存。編集中の端末の版だけが変わります。',
    ...
    visualEditLogoHint: 'プロンプトを編集し、参考画像があれば追加できます。背景とサイズは入力済みです。編集・再生成はこの位置だけ保存します。',
    visualEditLogoPromptLabel: 'ロゴのプロンプト',
    visualEditLogoPromptPlaceholder: '例：188.com.vn のワードマーク、ミニマル、枠なし、白背景…',
    visualEditLogoReferenceLabel: '参考画像',
    visualEditLogoReferenceHint: 'AIの参考用にサンプルロゴをアップロード。',
    visualEditRemoveReference: '参考画像を削除',
    visualEditLogoCropX: '横トリミング',
    visualEditLogoCropY: '縦トリミング',
    visualEditAddWidget: '追加',
    visualEditAddLogo: 'ロゴを追加',
    visualEditAddLogoHint: 'ドラッグして矩形を描きます。ロゴはその枠の比率・位置に合わせ、周囲の背景色を使います。',
    ...
    setupChangeTemplateConfirm:
      'テンプレート変更はクイック編集した全ページを上書きします。商品とカートのデータは残ります。続行しますか？',
  ...
  ko: {
    ...
    visualEditSelectHint: '텍스트/버튼 클릭 · 배너에서 블록 또는 이미지 · 이동 아이콘을 드래그',
    previewPageLabel: '페이지',
    visualEditAllPagesHint: '페이지와 기기(모바일/데스크톱)를 고른 뒤 빠른 편집 — 레이아웃은 따로 저장됩니다.',
    visualEditDeviceDesktop: '데스크톱 레이아웃 편집 중',
    visualEditDeviceMobile: '모바일 레이아웃 편집 중',
    visualEditDeviceHint: '모바일과 데스크톱은 따로 저장됩니다. 지금 보는 기기의 레이아웃만 바뀝니다.',
    ...
    visualEditLogoHint: '프롬프트를 수정하고 참고 이미지가 있으면 올리세요. 배경과 크기는 미리 채워집니다. 수정·재생성은 선택한 자리만 저장됩니다.',
    visualEditLogoPromptLabel: '로고 프롬프트',
    visualEditLogoPromptPlaceholder: '예: 188.com.vn 워드마크, 미니멀, 테두리 없음, 흰 배경…',
    visualEditLogoReferenceLabel: '참고 이미지',
    visualEditLogoReferenceHint: 'AI가 참고할 샘플 로고를 업로드하세요.',
    visualEditRemoveReference: '참고 이미지 삭제',
    visualEditLogoCropX: '가로 자르기',
    visualEditLogoCropY: '세로 자르기',
    visualEditAddWidget: '추가',
    visualEditAddLogo: '로고 추가',
    visualEditAddLogoHint: '드래그해서 사각형을 그리면 그 비율·위치에 로고가 들어가고 주변 배경색을 씁니다.',
    ...
    setupChangeTemplateConfirm:
      '템플릿을 바꾸면 빠른 편집한 모든 페이지가 덮어씌워집니다. 상품과 장바구니 데이터는 유지됩니다. 계속할까요?',
