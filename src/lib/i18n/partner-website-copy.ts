...
export type PartnerWebsiteCopy = {
  ...
  logosCreate: string
  logosCreateHint: string
  logosCreatePromptLabel: string
  ...
  logosCreateSuccess: string
  logosCreateError: string
  logosVersionsTitle: string
  logosVersionActive: string
  ...
  visualEditChromeKitPdpNavHint: string
  ...
  visualEditAddBannerHint: string
  ...
  visualEditGridRowsLabel: string
  ...
  listingFacetCacheTitle: string
  listingFacetCacheHint: string
  listingFacetCacheLoadError: string
  listingFacetCacheEmpty: string
  listingFacetCacheScopeCategory: string
  listingFacetCacheScopeSearch: string
  listingFacetCacheCountCategory: string
  listingFacetCacheCountSearch: string
  listingFacetCacheRebuildCategory: string
  listingFacetCacheRebuildSearch: string
  listingFacetCacheRebuildAll: string
  listingFacetCacheRebuildAllConfirm: string
  listingFacetCacheRebuildOk: string
  listingFacetCacheRebuildError: string
  listingFacetCachePinLabel: string
  listingFacetCachePinPlaceholder: string
  listingFacetCachePin: string
  listingFacetCachePinRequired: string
  listingFacetCachePinOk: string
  listingFacetCachePinError: string
  listingFacetCacheFilter: string
  listingFacetCacheFilterAll: string
  listingFacetCacheColScope: string
  listingFacetCacheColLabel: string
  listingFacetCacheColProducts: string
  listingFacetCacheColFacets: string
  listingFacetCacheColPrice: string
  listingFacetCacheColUpdated: string
  listingFacetCacheStale: string
  listingFacetCacheDeleteConfirm: string
  listingFacetCacheDeleteOk: string
  listingFacetCacheDeleteError: string
  searchCacheTitle: string
  searchCacheHint: string
  searchCacheLoadError: string
  searchCacheKeywordDays: string
  searchCacheKeywordHint: string
  searchCacheColKeyword: string
  searchCacheColHits: string
  searchCacheKeywordsEmpty: string
  searchCacheIdListTitle: string
  searchCacheIdListHint: string
  searchCacheIdListEmpty: string
  searchCacheClearAll: string
  searchCacheClearAllConfirm: string
  searchCacheClearOk: string
  searchCacheClearError: string
  searchCacheDeleteConfirm: string
  searchCacheDeleteOk: string
  searchCacheScopeCategory: string
  searchCacheScopeShop: string
  searchCacheColScope: string
  searchCacheColKey: string
  searchCacheColProducts: string
  searchCacheColIds: string
  searchCacheColUpdated: string
  searchCacheStale: string
  ...
  reviewsAdminPageTitle: string
  qaAdminPageTitle: string
  reviewsAdminImporting: string
  reviewsAdminViewWebsite: string
  reviewsAdminAutosaveHint: string
  reviewsAdminDisplayLogicLabel: string
  ...
  reviewsAdminDeleting: string
  reviewsAdminLoading: string
  reviewsAdminColStt: string
  reviewsAdminColType: string
  reviewsAdminColShowAt: string
  reviewsAdminColActions: string
  reviewsAdminColActive: string
  reviewsAdminColTime: string
  reviewsAdminColReply: string
  reviewsAdminContentCol: string
  reviewsAdminTypeImport: string
  reviewsAdminTypeCustomer: string
  reviewsAdminShowGroup: string
  reviewsAdminShowProduct: string
  reviewsAdminActiveShow: string
  reviewsAdminActiveHide: string
  reviewsAdminViewReview: string
  reviewsAdminSaving: string
  reviewsAdminWaitingSave: string
  reviewsAdminDeleted: string
  reviewsAdminDeleteFailed: string
  reviewsAdminSaveFailed: string
  reviewsAdminLoadFailed: string
  reviewsAdminDeleteAllConfirmCount: string
  reviewsAdminDeletedCount: string
  qaAdminSearchGroupLabel: string
  qaAdminSearchGroupPlaceholder: string
  qaAdminAddInTable: string
  qaAdminResetColWidths: string
  qaAdminResetColWidthsOk: string
  qaAdminShowCount: string
  qaAdminColView: string
  qaAdminColAsker: string
  qaAdminColAskContent: string
  qaAdminColUsefulCount: string
  qaAdminColAdminName: string
  qaAdminColAdminContent: string
  qaAdminColUserOneName: string
  qaAdminColUserOneContent: string
  qaAdminColUserTwoName: string
  qaAdminColUserTwoContent: string
  qaAdminColStatusDelete: string
  qaAdminColAskedAt: string
  qaAdminColProductId: string
  qaAdminColUpdatedAt: string
  qaAdminColAdminRepliedAt: string
  qaAdminColUserOneId: string
  qaAdminColUserOneAt: string
  qaAdminColUserTwoId: string
  qaAdminColUserTwoAt: string
  qaAdminColReplyCount: string
  qaAdminViewQuestion: string
  qaAdminReplyCountLocked: string
  qaAdminResizeCol: string
  qaAdminDelete: string
...
const COPY: Record<WebLocale, PartnerWebsiteCopy> = {
  vi: {
    ...
    logosChatHint: 'Một ảnh dùng chung mọi máy — nút Chat mua trên web và icon tin nhắn.',
    ...
    visualEditChromeDuplicate:
      'Thêm tại khe + trên trang, hoặc sửa cái đang có.',
    visualEditChromeDupAskTitle: 'Đã có «{name}»',
    visualEditChromeDupAskAdd: 'Thêm tại khe này',
    visualEditChromeDupAskKeep: 'Sửa cái đang có',
    ...
    visualEditAddWidget: 'Thêm tại khe này',
    ...
    visualEditAddToolbarHint: 'Chèn bằng nút + trên trang. Không kéo thả giữa canvas.',
    ...
    visualEditChromeKitFloatSizeHint: 'Mỗi nút một cách phải và một cỡ. Ô đầu = cách phải, ô sau = cỡ. Gõ số trên hàng đó.',
    ...
    visualEditChromeKitPdpNavHint:
      'Ba icon trái có thể đổi (Trang chủ, Thử đồ, Thích hoặc phần tử khác). Tối đa 3. Thêm giỏ và Mua luôn hiện.',
    ...
    visualEditAddBanner: 'Thêm banner',
    visualEditAddBannerHint: 'Khối vuốt ngang: sinh nhật, sale trùng tháng, sale kho, banner thường',
    ...
    visualEditAddPromoBanner: 'Thêm banner',
    ...
    searchAliasesPanelTitle: "Từ khóa mapping",
    ...
    listingFacetCacheTitle: "Cache bộ lọc",
    listingFacetCacheHint:
      "Bộ lọc size / màu / kiểu / giá lưu sẵn cho danh mục và từ khóa tìm kiếm. Tự làm mới khi sửa kho — bump version Redis rồi ghi lại Postgres.",
    listingFacetCacheLoadError: "Không tải được cache bộ lọc.",
    listingFacetCacheEmpty: "Chưa có snapshot bộ lọc.",
    listingFacetCacheScopeCategory: "Danh mục",
    listingFacetCacheScopeSearch: "Tìm kiếm",
    listingFacetCacheCountCategory: "Danh mục",
    listingFacetCacheCountSearch: "Từ khóa",
    listingFacetCacheRebuildCategory: "Rebuild danh mục",
    listingFacetCacheRebuildSearch: "Rebuild từ khóa",
    listingFacetCacheRebuildAll: "Rebuild tất cả",
    listingFacetCacheRebuildAllConfirm: "Rebuild toàn bộ cache bộ lọc? Có thể mất vài phút với kho lớn.",
    listingFacetCacheRebuildOk: "Đã rebuild {count} bộ lọc.",
    listingFacetCacheRebuildError: "Rebuild thất bại.",
    listingFacetCachePinLabel: "Ghim từ khóa",
    listingFacetCachePinPlaceholder: "vd. váy hoa",
    listingFacetCachePin: "Ghim",
    listingFacetCachePinRequired: "Nhập từ khóa tìm kiếm.",
    listingFacetCachePinOk: "Đã ghim cache bộ lọc cho «{keyword}».",
    listingFacetCachePinError: "Không ghim được từ khóa.",
    listingFacetCacheFilter: "Lọc",
    listingFacetCacheFilterAll: "Tất cả",
    listingFacetCacheColScope: "Phạm vi",
    listingFacetCacheColLabel: "Nhãn",
    listingFacetCacheColProducts: "SP",
    listingFacetCacheColFacets: "Size/màu/kiểu",
    listingFacetCacheColPrice: "Giá",
    listingFacetCacheColUpdated: "Cập nhật",
    listingFacetCacheStale: "Cũ",
    listingFacetCacheDeleteConfirm: "Xóa cache «{label}»?",
    listingFacetCacheDeleteOk: "Đã xóa cache bộ lọc.",
    listingFacetCacheDeleteError: "Không xóa được cache.",
    searchCacheTitle: "Cache & thống kê tìm kiếm",
    searchCacheHint:
      "Từ khóa khách đã tìm (lịch sử tài khoản). Cache id list listing danh mục / catalog shop nằm Postgres; tìm chữ JSON chỉ Redis — xóa sẽ bump version kho.",
    searchCacheLoadError: "Không tải được cache tìm kiếm.",
    searchCacheKeywordDays: "Số ngày",
    searchCacheKeywordHint: "Đếm trên hồ sơ khách còn hoạt động trong cửa sổ ngày.",
    searchCacheColKeyword: "Từ khóa",
    searchCacheColHits: "Lượt",
    searchCacheKeywordsEmpty: "Chưa có từ khóa tìm kiếm.",
    searchCacheIdListTitle: "Cache danh sách id",
    searchCacheIdListHint: "Lớp Postgres cho listing danh mục và catalog shop (không gồm tìm chữ).",
    searchCacheIdListEmpty: "Chưa có dòng cache id.",
    searchCacheClearAll: "Xóa toàn bộ",
    searchCacheClearAllConfirm: "Xóa cache id list listing và làm mới version kho? Khách sẽ tải lại từ DB.",
    searchCacheClearOk: "Đã xóa {count} dòng cache.",
    searchCacheClearError: "Không xóa được cache.",
    searchCacheDeleteConfirm: "Xóa cache «{key}»?",
    searchCacheDeleteOk: "Đã xóa dòng cache.",
    searchCacheScopeCategory: "Danh mục",
    searchCacheScopeShop: "Catalog shop",
    searchCacheColScope: "Phạm vi",
    searchCacheColKey: "Khóa",
    searchCacheColProducts: "SP",
    searchCacheColIds: "Id",
    searchCacheColUpdated: "Cập nhật",
    searchCacheStale: "Cũ",
    ...
    reviewsAdminEmpty: 'Chưa có đánh giá nào. Dùng Import để tải file Excel.',
    reviewsAdminFilterAll: 'Tất cả sao',
    reviewsAdminDeleteAll: 'Xóa hết đánh giá',
    ...
    reviewsAdminDownloadSample: 'Tải file Excel mẫu',
    reviewsAdminImport: 'Import',
    ...
    qaAdminEmpty: 'Chưa có câu hỏi nào. Dùng Import để tải file Excel.',
    ...
    qaAdminDownloadSample: 'Tải file Excel mẫu',
    qaAdminImport: 'Import',
    ...
    reviewsAdminPageTitle: 'Quản lý đánh giá sản phẩm',
    qaAdminPageTitle: 'Tất cả Câu hỏi Câu trả lời sản phẩm',
    reviewsAdminImporting: 'Đang import...',
    reviewsAdminViewWebsite: 'Xem website',
    reviewsAdminAutosaveHint: 'Sửa trực tiếp trong bảng — hệ thống tự lưu sau ~0,7 giây.',
    reviewsAdminDisplayLogicLabel: 'Logic hiển thị:',
    reviewsAdminDisplayLogic:
    ...
    reviewsAdminDeleting: 'Đang xóa...',
    reviewsAdminLoading: 'Đang tải...',
    reviewsAdminColStt: 'STT',
    reviewsAdminColType: 'Loại',
    reviewsAdminColShowAt: 'Hiển thị tại',
    reviewsAdminColActions: 'Chức năng',
    reviewsAdminColActive: 'Kích hoạt',
    reviewsAdminColTime: 'Thời gian',
    reviewsAdminColReply: 'Trả lời',
    reviewsAdminContentCol: 'Nội dung',
    reviewsAdminTypeImport: 'Import',
    reviewsAdminTypeCustomer: 'Khách hàng',
    reviewsAdminShowGroup: 'Nhóm {n}',
    reviewsAdminShowProduct: 'SP #{id}',
    reviewsAdminActiveShow: 'Hiển thị',
    reviewsAdminActiveHide: 'Ẩn',
    reviewsAdminViewReview: 'Xem đánh giá',
    reviewsAdminSaving: 'Đang lưu...',
    reviewsAdminWaitingSave: 'Chờ lưu...',
    reviewsAdminDeleted: 'Đã xóa',
    reviewsAdminDeleteFailed: 'Xóa thất bại',
    reviewsAdminSaveFailed: 'Lưu thất bại',
    reviewsAdminLoadFailed: 'Lỗi tải danh sách',
    reviewsAdminDeleteAllConfirmCount: 'Bạn có chắc muốn xóa HẾT {n} đánh giá? Thao tác này không thể hoàn tác.',
    reviewsAdminDeletedCount: 'Đã xóa {n} đánh giá',
    qaAdminSearchGroupLabel: 'Tìm kiếm theo Nhóm câu hỏi',
    qaAdminSearchGroupPlaceholder: 'Nhập số nhóm...',
    qaAdminAddInTable: 'Thêm mới (form tạo trong bảng)',
    qaAdminResetColWidths: 'Đặt lại độ rộng cột',
    qaAdminResetColWidthsOk: 'Đã đặt lại độ rộng cột',
    qaAdminShowCount: 'Hiển thị',
    qaAdminColView: 'Xem',
    qaAdminColAsker: 'Tên người hỏi',
    qaAdminColAskContent: 'Nội dung hỏi',
    qaAdminColUsefulCount: 'Lượt thấy hữu ích',
    qaAdminColAdminName: 'Tên Admin trả lời',
    qaAdminColAdminContent: 'Nội dung admin trả lời',
    qaAdminColUserOneName: 'Tên user 1',
    qaAdminColUserOneContent: 'Nội dung user 1',
    qaAdminColUserTwoName: 'Tên user 2',
    qaAdminColUserTwoContent: 'Nội dung user 2',
    qaAdminColStatusDelete: 'Trạng thái / Xóa',
    qaAdminColAskedAt: 'Thời gian hỏi',
    qaAdminColProductId: 'ID SP',
    qaAdminColUpdatedAt: 'Thời gian update',
    qaAdminColAdminRepliedAt: 'Thời gian admin TL',
    qaAdminColUserOneId: 'ID user 1',
    qaAdminColUserOneAt: 'Thời gian user 1',
    qaAdminColUserTwoId: 'ID user 2',
    qaAdminColUserTwoAt: 'Thời gian user 2',
    qaAdminColReplyCount: 'Số TL',
    qaAdminViewQuestion: 'Xem câu hỏi',
    qaAdminReplyCountLocked: '{n} (2=khóa)',
    qaAdminResizeCol: 'Kéo để thay đổi độ rộng cột',
    qaAdminDelete: 'Xóa',
    ...
    resetWebsiteSuccess: 'Đã reset. Bản web cũ được lưu 7 ngày. Bấm «Khôi phục web đã reset» trên thanh xem trước để lấy lại.',
    restoreResetTrashButton: 'Khôi phục web đã reset',
    restoreResetTrashHint:
      'Bản web trước lần reset còn khoảng {days} ngày. Bấm khôi phục để lấy lại, kể cả khi đã có web mới.',
  ...
  en: {
    ...
    logosChatHint: 'One image for every device — the Chat mua button and the message icon.',
    ...
    visualEditChromeDuplicate:
      'Add at a + gap on the page, or edit the one already there.',
    visualEditChromeDupAskTitle: '«{name}» already exists',
    visualEditChromeDupAskAdd: 'Add at this gap',
    visualEditChromeDupAskKeep: 'Edit the existing one',
    ...
    visualEditAddWidget: 'Add at this gap',
    ...
    visualEditAddToolbarHint: 'Insert with the + marks on the page. Canvas drag-and-drop is off.',
    ...
    visualEditChromeKitFloatSizeHint: 'Each button has its own from-right and size. First box = from right, second = size. Type the px on that row.',
    ...
    visualEditChromeKitPdpNavHint:
      'The 3 left icons can be swapped (Home, Try-on, Like, or another dock item). Max 3. Add to cart and Buy stay on.',
    ...
    visualEditAddBanner: 'Add banner',
    visualEditAddBannerHint: 'Swipe block: birthday, same-day sale, warehouse sale, regular banner',
    ...
    visualEditAddPromoBanner: 'Add banner',
    ...
    visualEditGridRowsLabel: 'Rows',
    visualEditGridRowsHint: 'See more adds the same number of rows.',
    ...
    searchAliasesPanelTitle: "Keyword mapping",
    ...
    listingFacetCacheTitle: "Listing filter cache",
    listingFacetCacheHint:
      "Size / color / style / price facets stored for categories and search keywords. Inventory edits bump Redis then rewrite Postgres.",
    listingFacetCacheLoadError: "Could not load filter cache.",
    listingFacetCacheEmpty: "No filter snapshots yet.",
    listingFacetCacheScopeCategory: "Category",
    listingFacetCacheScopeSearch: "Search",
    listingFacetCacheCountCategory: "Categories",
    listingFacetCacheCountSearch: "Keywords",
    listingFacetCacheRebuildCategory: "Rebuild categories",
    listingFacetCacheRebuildSearch: "Rebuild keywords",
    listingFacetCacheRebuildAll: "Rebuild all",
    listingFacetCacheRebuildAllConfirm: "Rebuild every filter cache snapshot? This can take a few minutes on large catalogs.",
    listingFacetCacheRebuildOk: "Rebuilt {count} filter caches.",
    listingFacetCacheRebuildError: "Rebuild failed.",
    listingFacetCachePinLabel: "Pin keyword",
    listingFacetCachePinPlaceholder: "e.g. floral dress",
    listingFacetCachePin: "Pin",
    listingFacetCachePinRequired: "Enter a search keyword.",
    listingFacetCachePinOk: "Pinned filter cache for “{keyword}”.",
    listingFacetCachePinError: "Could not pin that keyword.",
    listingFacetCacheFilter: "Filter",
    listingFacetCacheFilterAll: "All",
    listingFacetCacheColScope: "Scope",
    listingFacetCacheColLabel: "Label",
    listingFacetCacheColProducts: "Products",
    listingFacetCacheColFacets: "Size/color/style",
    listingFacetCacheColPrice: "Price",
    listingFacetCacheColUpdated: "Updated",
    listingFacetCacheStale: "Stale",
    listingFacetCacheDeleteConfirm: "Delete cache “{label}”?",
    listingFacetCacheDeleteOk: "Filter cache deleted.",
    listingFacetCacheDeleteError: "Could not delete cache.",
    searchCacheTitle: "Search cache & stats",
    searchCacheHint:
      "Shopper keywords from account history. Category / shop listing id lists sit in Postgres; text-search JSON is Redis-only — clearing bumps inventory version.",
    searchCacheLoadError: "Could not load search cache.",
    searchCacheKeywordDays: "Days",
    searchCacheKeywordHint: "Counts keywords on visitor profiles active in this window.",
    searchCacheColKeyword: "Keyword",
    searchCacheColHits: "Hits",
    searchCacheKeywordsEmpty: "No search keywords yet.",
    searchCacheIdListTitle: "Id-list cache",
    searchCacheIdListHint: "Postgres layer for category listing and shop catalog (not text search).",
    searchCacheIdListEmpty: "No id-list cache rows yet.",
    searchCacheClearAll: "Clear all",
    searchCacheClearAllConfirm: "Delete listing id-list cache and bump inventory version? Shoppers will reload from the database.",
    searchCacheClearOk: "Deleted {count} cache rows.",
    searchCacheClearError: "Could not clear cache.",
    searchCacheDeleteConfirm: "Delete cache “{key}”?",
    searchCacheDeleteOk: "Cache row deleted.",
    searchCacheScopeCategory: "Category",
    searchCacheScopeShop: "Shop catalog",
    searchCacheColScope: "Scope",
    searchCacheColKey: "Key",
    searchCacheColProducts: "Products",
    searchCacheColIds: "Ids",
    searchCacheColUpdated: "Updated",
    searchCacheStale: "Stale",
    ...
    reviewsAdminEmpty: 'No reviews yet. Use Import to upload an Excel file.',
    ...
    reviewsAdminDownloadSample: 'Download Excel sample',
    reviewsAdminImport: 'Import',
    ...
    qaAdminEmpty: 'No questions yet. Use Import to upload an Excel file.',
    ...
    qaAdminDownloadSample: 'Download Excel sample',
    qaAdminImport: 'Import',
    ...
    reviewsAdminPageTitle: 'Product review management',
    qaAdminPageTitle: 'All product questions and answers',
    reviewsAdminImporting: 'Importing...',
    reviewsAdminViewWebsite: 'View website',
    reviewsAdminAutosaveHint: 'Edit directly in the table — the system autosaves after about 0.7 seconds.',
    reviewsAdminDisplayLogicLabel: 'Display logic:',
    reviewsAdminDisplayLogic:
    ...
    reviewsAdminDeleting: 'Deleting...',
    reviewsAdminLoading: 'Loading...',
    reviewsAdminColStt: 'No.',
    reviewsAdminColType: 'Type',
    reviewsAdminColShowAt: 'Shown on',
    reviewsAdminColActions: 'Actions',
    reviewsAdminColActive: 'Active',
    reviewsAdminColTime: 'Time',
    reviewsAdminColReply: 'Reply',
    reviewsAdminContentCol: 'Content',
    reviewsAdminTypeImport: 'Import',
    reviewsAdminTypeCustomer: 'Customer',
    reviewsAdminShowGroup: 'Group {n}',
    reviewsAdminShowProduct: 'SKU #{id}',
    reviewsAdminActiveShow: 'Visible',
    reviewsAdminActiveHide: 'Hidden',
    reviewsAdminViewReview: 'View review',
    reviewsAdminSaving: 'Saving...',
    reviewsAdminWaitingSave: 'Pending save...',
    reviewsAdminDeleted: 'Deleted',
    reviewsAdminDeleteFailed: 'Delete failed',
    reviewsAdminSaveFailed: 'Save failed',
    reviewsAdminLoadFailed: 'Could not load the list',
    reviewsAdminDeleteAllConfirmCount: 'Delete ALL {n} reviews? This cannot be undone.',
    reviewsAdminDeletedCount: 'Deleted {n} reviews',
    qaAdminSearchGroupLabel: 'Search by question group',
    qaAdminSearchGroupPlaceholder: 'Enter group number...',
    qaAdminAddInTable: 'Add new (edit in the table)',
    qaAdminResetColWidths: 'Reset column widths',
    qaAdminResetColWidthsOk: 'Column widths reset',
    qaAdminShowCount: 'Show',
    qaAdminColView: 'View',
    qaAdminColAsker: 'Asker name',
    qaAdminColAskContent: 'Question',
    qaAdminColUsefulCount: 'Useful count',
    qaAdminColAdminName: 'Admin reply name',
    qaAdminColAdminContent: 'Admin reply',
    qaAdminColUserOneName: 'User 1 name',
    qaAdminColUserOneContent: 'User 1 content',
    qaAdminColUserTwoName: 'User 2 name',
    qaAdminColUserTwoContent: 'User 2 content',
    qaAdminColStatusDelete: 'Status / Delete',
    qaAdminColAskedAt: 'Asked at',
    qaAdminColProductId: 'Product ID',
    qaAdminColUpdatedAt: 'Updated at',
    qaAdminColAdminRepliedAt: 'Admin replied at',
    qaAdminColUserOneId: 'User 1 ID',
    qaAdminColUserOneAt: 'User 1 time',
    qaAdminColUserTwoId: 'User 2 ID',
    qaAdminColUserTwoAt: 'User 2 time',
    qaAdminColReplyCount: 'Replies',
    qaAdminViewQuestion: 'View question',
    qaAdminReplyCountLocked: '{n} (2=locked)',
    qaAdminResizeCol: 'Drag to resize column',
    qaAdminDelete: 'Delete',
    ...
    resetWebsiteSuccess: 'Site reset. The previous site is kept for 7 days. Use “Restore reset website” on the preview bar to bring it back.',
    restoreResetTrashButton: 'Restore reset website',
    restoreResetTrashHint:
      'The site from before reset is kept for about {days} days. Restore brings it back, even if a new site exists.',
  ...
  zh: {
    ...
    logosChatHint: '所有设备共用一张图 — 网站「购物聊天」按钮与消息图标。',
    logosEmpty: '暂无图片',
    logosSaved: '已保存 Logo。',
    ...
    visualEditChromeDuplicate: '用页面上的 + 空隙添加，或编辑已有的那个。',
    visualEditChromeDupAskTitle: '已有「{name}」',
    visualEditChromeDupAskAdd: '在此空隙添加',
    visualEditChromeDupAskKeep: '编辑现有的',
    ...
    visualEditAddToolbarHint: '用页面上的 + 插入。画布不可拖放。',
    ...
    visualEditChromeKitFloatSizeHint: '每个按钮单独距右和尺寸。前框=距右，后框=尺寸。在该行输入 px。',
    ...
    visualEditChromeKitPdpNavHint: '左侧最多 3 个图标可更换（首页、试穿、喜欢或其他底栏项）。加入购物车和购买始终显示。',
    ...
    visualEditAddBanner: '添加横幅',
    visualEditAddBannerHint: '横滑区块：生日、同日促销、仓库特卖、普通横幅',
    ...
    visualEditGridRowsLabel: '行数',
    visualEditGridRowsHint: '查看更多会再显示同样行数。',
    ...
    listingFacetCacheTitle: "筛选缓存",
    listingFacetCacheHint:
      "尺码 / 颜色 / 风格 / 价格筛选会按类目和搜索词预存。改库存会提升 Redis 版本再写回 Postgres。",
    listingFacetCacheLoadError: "无法加载筛选缓存。",
    listingFacetCacheEmpty: "还没有筛选快照。",
    listingFacetCacheScopeCategory: "类目",
    listingFacetCacheScopeSearch: "搜索",
    listingFacetCacheCountCategory: "类目",
    listingFacetCacheCountSearch: "关键词",
    listingFacetCacheRebuildCategory: "重建类目",
    listingFacetCacheRebuildSearch: "重建关键词",
    listingFacetCacheRebuildAll: "全部重建",
    listingFacetCacheRebuildAllConfirm: "重建全部筛选缓存？大目录可能需要几分钟。",
    listingFacetCacheRebuildOk: "已重建 {count} 条筛选缓存。",
    listingFacetCacheRebuildError: "重建失败。",
    listingFacetCachePinLabel: "固定关键词",
    listingFacetCachePinPlaceholder: "例如 碎花裙",
    listingFacetCachePin: "固定",
    listingFacetCachePinRequired: "请输入搜索关键词。",
    listingFacetCachePinOk: "已为「{keyword}」固定筛选缓存。",
    listingFacetCachePinError: "无法固定该关键词。",
    listingFacetCacheFilter: "筛选",
    listingFacetCacheFilterAll: "全部",
    listingFacetCacheColScope: "范围",
    listingFacetCacheColLabel: "标签",
    listingFacetCacheColProducts: "商品",
    listingFacetCacheColFacets: "尺码/颜色/风格",
    listingFacetCacheColPrice: "价格",
    listingFacetCacheColUpdated: "更新",
    listingFacetCacheStale: "过期",
    listingFacetCacheDeleteConfirm: "删除缓存「{label}」？",
    listingFacetCacheDeleteOk: "已删除筛选缓存。",
    listingFacetCacheDeleteError: "无法删除缓存。",
    searchCacheTitle: "搜索缓存与统计",
    searchCacheHint:
      "顾客账号历史中的搜索词。类目 / 店铺列表 id 缓存在 Postgres；文字搜索 JSON 只在 Redis — 清除会提升库存版本。",
    searchCacheLoadError: "无法加载搜索缓存。",
    searchCacheKeywordDays: "天数",
    searchCacheKeywordHint: "统计该时间窗口内仍活跃的访客档案关键词。",
    searchCacheColKeyword: "关键词",
    searchCacheColHits: "次数",
    searchCacheKeywordsEmpty: "还没有搜索关键词。",
    searchCacheIdListTitle: "Id 列表缓存",
    searchCacheIdListHint: "类目列表和店铺目录的 Postgres 层（不含文字搜索）。",
    searchCacheIdListEmpty: "还没有 id 列表缓存。",
    searchCacheClearAll: "全部清除",
    searchCacheClearAllConfirm: "删除列表 id 缓存并提升库存版本？顾客将从数据库重新加载。",
    searchCacheClearOk: "已删除 {count} 条缓存。",
    searchCacheClearError: "无法清除缓存。",
    searchCacheDeleteConfirm: "删除缓存「{key}」？",
    searchCacheDeleteOk: "已删除该缓存行。",
    searchCacheScopeCategory: "类目",
    searchCacheScopeShop: "店铺目录",
    searchCacheColScope: "范围",
    searchCacheColKey: "键",
    searchCacheColProducts: "商品",
    searchCacheColIds: "Id",
    searchCacheColUpdated: "更新",
    searchCacheStale: "过期",
    ...
    reviewsAdminEmpty: '暂无评价。请用 Import 上传 Excel。',
    ...
    reviewsAdminDownloadSample: '下载 Excel 模板',
    reviewsAdminImport: '导入',
    ...
    reviewsAdminPageTitle: '商品评价管理',
    qaAdminPageTitle: '全部商品问答',
    reviewsAdminImporting: '正在导入...',
    reviewsAdminViewWebsite: '查看网站',
    reviewsAdminAutosaveHint: '直接在表格中修改 — 系统约 0.7 秒后自动保存。',
    reviewsAdminDisplayLogicLabel: '显示逻辑：',
    reviewsAdminDisplayLogic:
    ...
    reviewsAdminDeleting: '正在删除...',
    reviewsAdminLoading: '加载中...',
    reviewsAdminColStt: '序号',
    reviewsAdminColType: '类型',
    reviewsAdminColShowAt: '显示位置',
    reviewsAdminColActions: '操作',
    reviewsAdminColActive: '启用',
    reviewsAdminColTime: '时间',
    reviewsAdminColReply: '回复',
    reviewsAdminContentCol: '内容',
    reviewsAdminTypeImport: '导入',
    reviewsAdminTypeCustomer: '顾客',
    reviewsAdminShowGroup: '组别 {n}',
    reviewsAdminShowProduct: '商品 #{id}',
    reviewsAdminActiveShow: '显示',
    reviewsAdminActiveHide: '隐藏',
    reviewsAdminViewReview: '查看评价',
    reviewsAdminSaving: '正在保存...',
    reviewsAdminWaitingSave: '待保存...',
    reviewsAdminDeleted: '已删除',
    reviewsAdminDeleteFailed: '删除失败',
    reviewsAdminSaveFailed: '保存失败',
    reviewsAdminLoadFailed: '无法加载列表',
    reviewsAdminDeleteAllConfirmCount: '确定删除全部 {n} 条评价？此操作无法撤销。',
    reviewsAdminDeletedCount: '已删除 {n} 条评价',
    qaAdminSearchGroupLabel: '按问题组别搜索',
    qaAdminSearchGroupPlaceholder: '输入组别编号...',
    qaAdminAddInTable: '新增（在表格中编辑）',
    qaAdminResetColWidths: '重置列宽',
    qaAdminResetColWidthsOk: '已重置列宽',
    qaAdminShowCount: '显示',
    qaAdminColView: '查看',
    qaAdminColAsker: '提问者姓名',
    qaAdminColAskContent: '问题内容',
    qaAdminColUsefulCount: '有用次数',
    qaAdminColAdminName: '管理员回复名',
    qaAdminColAdminContent: '管理员回复内容',
    qaAdminColUserOneName: '用户 1 姓名',
    qaAdminColUserOneContent: '用户 1 内容',
    qaAdminColUserTwoName: '用户 2 姓名',
    qaAdminColUserTwoContent: '用户 2 内容',
    qaAdminColStatusDelete: '状态 / 删除',
    qaAdminColAskedAt: '提问时间',
    qaAdminColProductId: '商品 ID',
    qaAdminColUpdatedAt: '更新时间',
    qaAdminColAdminRepliedAt: '管理员回复时间',
    qaAdminColUserOneId: '用户 1 ID',
    qaAdminColUserOneAt: '用户 1 时间',
    qaAdminColUserTwoId: '用户 2 ID',
    qaAdminColUserTwoAt: '用户 2 时间',
    qaAdminColReplyCount: '回复数',
    qaAdminViewQuestion: '查看问题',
    qaAdminReplyCountLocked: '{n}（2=锁定）',
    qaAdminResizeCol: '拖动以调整列宽',
    qaAdminDelete: '删除',
    ...
    resetWebsiteSuccess: '已重置。旧网站保存 7 天。在预览栏点「恢复已重置的网站」即可取回。',
    restoreResetTrashButton: '恢复已重置的网站',
    restoreResetTrashHint: '重置前的网站还保留约 {days} 天。即使已有新网站，也可点恢复取回。',
  ...
  ja: {
    ...
    logosChatHint: '全端末で共通 — サイトのチャット購入ボタンとメッセージアイコン。',
    logosEmpty: '画像なし',
    ...
    visualEditChromeDuplicate: 'ページ上の + 隙間に追加するか、既存のものを編集します。',
    visualEditChromeDupAskTitle: '「{name}」は既にあります',
    visualEditChromeDupAskAdd: 'この隙間に追加',
    visualEditChromeDupAskKeep: '既存のものを編集',
    ...
    visualEditAddToolbarHint: 'ページ上の + で挿入します。キャンバスのドラッグはオフです。',
    ...
    visualEditChromeKitFloatSizeHint: 'ボタンごとに右余白とサイズが違います。前の枠=右から、後の枠=サイズ。その行の px を入力します。',
    ...
    visualEditChromeKitPdpNavHint:
      '左の3つのアイコンは差し替え可能です（ホーム、試着、いいね、または他の項目）。最大3つ。カート追加と購入は常に表示。',
    ...
    visualEditAddBanner: 'バナーを追加',
    visualEditAddBannerHint: '横スライド：誕生日、同日セール、倉庫セール、通常バナー',
    ...
    visualEditAddPromoBanner: 'バナーを追加',
    ...
    visualEditGridRowsLabel: '行数',
    visualEditGridRowsHint: 'もっと見ると同じ行数が追加されます。',
    ...
    searchAliasesPanelTitle: "キーワード対応",
    ...
    listingFacetCacheTitle: "絞り込みキャッシュ",
    listingFacetCacheHint:
      "サイズ / カラー / スタイル / 価格の絞り込みをカテゴリと検索語ごとに保存します。在庫変更で Redis バージョンを上げて Postgres に書き直します。",
    listingFacetCacheLoadError: "絞り込みキャッシュを読み込めませんでした。",
    listingFacetCacheEmpty: "絞り込みスナップショットはまだありません。",
    listingFacetCacheScopeCategory: "カテゴリ",
    listingFacetCacheScopeSearch: "検索",
    listingFacetCacheCountCategory: "カテゴリ",
    listingFacetCacheCountSearch: "キーワード",
    listingFacetCacheRebuildCategory: "カテゴリを再構築",
    listingFacetCacheRebuildSearch: "キーワードを再構築",
    listingFacetCacheRebuildAll: "すべて再構築",
    listingFacetCacheRebuildAllConfirm: "絞り込みキャッシュをすべて再構築しますか？大きなカタログでは数分かかることがあります。",
    listingFacetCacheRebuildOk: "{count} 件の絞り込みキャッシュを再構築しました。",
    listingFacetCacheRebuildError: "再構築に失敗しました。",
    listingFacetCachePinLabel: "キーワードを固定",
    listingFacetCachePinPlaceholder: "例: 花柄ワンピ",
    listingFacetCachePin: "固定",
    listingFacetCachePinRequired: "検索キーワードを入力してください。",
    listingFacetCachePinOk: "「{keyword}」の絞り込みキャッシュを固定しました。",
    listingFacetCachePinError: "キーワードを固定できませんでした。",
    listingFacetCacheFilter: "フィルター",
    listingFacetCacheFilterAll: "すべて",
    listingFacetCacheColScope: "範囲",
    listingFacetCacheColLabel: "ラベル",
    listingFacetCacheColProducts: "商品",
    listingFacetCacheColFacets: "サイズ/色/スタイル",
    listingFacetCacheColPrice: "価格",
    listingFacetCacheColUpdated: "更新",
    listingFacetCacheStale: "古い",
    listingFacetCacheDeleteConfirm: "キャッシュ「{label}」を削除しますか？",
    listingFacetCacheDeleteOk: "絞り込みキャッシュを削除しました。",
    listingFacetCacheDeleteError: "キャッシュを削除できませんでした。",
    searchCacheTitle: "検索キャッシュと統計",
    searchCacheHint:
      "顧客アカウント履歴の検索語。カテゴリ / ショップ一覧の id リストは Postgres、テキスト検索 JSON は Redis のみ — 削除すると在庫バージョンが上がります。",
    searchCacheLoadError: "検索キャッシュを読み込めませんでした。",
    searchCacheKeywordDays: "日数",
    searchCacheKeywordHint: "この期間に更新された訪問者プロフィールのキーワードを集計します。",
    searchCacheColKeyword: "キーワード",
    searchCacheColHits: "回数",
    searchCacheKeywordsEmpty: "検索キーワードはまだありません。",
    searchCacheIdListTitle: "Id リストキャッシュ",
    searchCacheIdListHint: "カテゴリ一覧とショップカタログの Postgres 層（テキスト検索は含みません）。",
    searchCacheIdListEmpty: "Id リストキャッシュはまだありません。",
    searchCacheClearAll: "すべて削除",
    searchCacheClearAllConfirm: "一覧 id キャッシュを削除し在庫バージョンを上げますか？お客様は DB から再読み込みします。",
    searchCacheClearOk: "{count} 件のキャッシュを削除しました。",
    searchCacheClearError: "キャッシュを削除できませんでした。",
    searchCacheDeleteConfirm: "キャッシュ「{key}」を削除しますか？",
    searchCacheDeleteOk: "キャッシュ行を削除しました。",
    searchCacheScopeCategory: "カテゴリ",
    searchCacheScopeShop: "ショップカタログ",
    searchCacheColScope: "範囲",
    searchCacheColKey: "キー",
    searchCacheColProducts: "商品",
    searchCacheColIds: "Id",
    searchCacheColUpdated: "更新",
    searchCacheStale: "古い",
    ...
    reviewsAdminEmpty: 'まだレビューがありません。Import で Excel をアップロードしてください。',
    ...
    reviewsAdminDownloadSample: 'Excelサンプルをダウンロード',
    reviewsAdminImport: 'Import',
    ...
    reviewsAdminPageTitle: '商品レビュー管理',
    qaAdminPageTitle: 'すべての商品Q&A',
    reviewsAdminImporting: '取り込み中...',
    reviewsAdminViewWebsite: 'サイトを見る',
    reviewsAdminAutosaveHint: '表で直接編集 — 約0.7秒後に自動保存されます。',
    reviewsAdminDisplayLogicLabel: '表示ロジック：',
    reviewsAdminDisplayLogic:
    ...
    reviewsAdminDeleting: '削除中...',
    reviewsAdminLoading: '読み込み中...',
    reviewsAdminColStt: 'No.',
    reviewsAdminColType: '種類',
    reviewsAdminColShowAt: '表示先',
    reviewsAdminColActions: '操作',
    reviewsAdminColActive: '有効',
    reviewsAdminColTime: '日時',
    reviewsAdminColReply: '返信',
    reviewsAdminContentCol: '内容',
    reviewsAdminTypeImport: 'Import',
    reviewsAdminTypeCustomer: '顧客',
    reviewsAdminShowGroup: 'グループ {n}',
    reviewsAdminShowProduct: '商品 #{id}',
    reviewsAdminActiveShow: '表示',
    reviewsAdminActiveHide: '非表示',
    reviewsAdminViewReview: 'レビューを見る',
    reviewsAdminSaving: '保存中...',
    reviewsAdminWaitingSave: '保存待ち...',
    reviewsAdminDeleted: '削除しました',
    reviewsAdminDeleteFailed: '削除に失敗しました',
    reviewsAdminSaveFailed: '保存に失敗しました',
    reviewsAdminLoadFailed: '一覧を読み込めませんでした',
    reviewsAdminDeleteAllConfirmCount: '{n}件のレビューをすべて削除しますか？元に戻せません。',
    reviewsAdminDeletedCount: '{n}件のレビューを削除しました',
    qaAdminSearchGroupLabel: '質問グループで検索',
    qaAdminSearchGroupPlaceholder: 'グループ番号を入力...',
    qaAdminAddInTable: '新規追加（表で編集）',
    qaAdminResetColWidths: '列幅をリセット',
    qaAdminResetColWidthsOk: '列幅をリセットしました',
    qaAdminShowCount: '表示',
    qaAdminColView: '表示',
    qaAdminColAsker: '質問者名',
    qaAdminColAskContent: '質問内容',
    qaAdminColUsefulCount: '参考になった数',
    qaAdminColAdminName: '管理者返信名',
    qaAdminColAdminContent: '管理者返信内容',
    qaAdminColUserOneName: 'ユーザー1名',
    qaAdminColUserOneContent: 'ユーザー1内容',
    qaAdminColUserTwoName: 'ユーザー2名',
    qaAdminColUserTwoContent: 'ユーザー2内容',
    qaAdminColStatusDelete: '状態 / 削除',
    qaAdminColAskedAt: '質問日時',
    qaAdminColProductId: '商品ID',
    qaAdminColUpdatedAt: '更新日時',
    qaAdminColAdminRepliedAt: '管理者返信日時',
    qaAdminColUserOneId: 'ユーザー1 ID',
    qaAdminColUserOneAt: 'ユーザー1日時',
    qaAdminColUserTwoId: 'ユーザー2 ID',
    qaAdminColUserTwoAt: 'ユーザー2日時',
    qaAdminColReplyCount: '返信数',
    qaAdminViewQuestion: '質問を見る',
    qaAdminReplyCountLocked: '{n}（2=ロック）',
    qaAdminResizeCol: 'ドラッグして列幅を変更',
    qaAdminDelete: '削除',
    ...
    resetWebsiteSuccess: 'リセットしました。旧Webは7日間保存されます。プレビュー欄の「リセットしたWebを復元」で戻せます。',
    restoreResetTrashButton: 'リセットしたWebを復元',
    restoreResetTrashHint: 'リセット前のWebは約{days}日残っています。新しいWebがあっても復元できます。',
  ...
  ko: {
    ...
    logosChatHint: '모든 기기에서 같은 이미지 — 사이트 구매 채팅 버튼과 메시지 아이콘.',
    logosEmpty: '이미지 없음',
    ...
    visualEditChromeDuplicate: '페이지의 + 칸에 추가하거나, 있는 것을 편집하세요.',
    visualEditChromeDupAskTitle: '이미 «{name}»이(가) 있습니다',
    visualEditChromeDupAskAdd: '이 칸에 추가',
    visualEditChromeDupAskKeep: '있는 것을 편집',
    ...
    visualEditAddToolbarHint: '페이지의 + 로 넣습니다. 캔버스 끌기는 끕니다.',
    ...
    visualEditChromeKitFloatSizeHint: '버튼마다 오른쪽 간격과 크기가 다릅니다. 앞 칸=오른쪽, 뒤 칸=크기. 그 행에 px를 입력하세요.',
    ...
    visualEditChromeKitPdpNavHint:
      '왼쪽 아이콘 3개는 바꿀 수 있습니다(홈, 가상 피팅, 좋아요 또는 다른 항목). 최대 3개. 장바구니/구매는 항상 표시됩니다.',
    ...
    visualEditAddBanner: '배너 추가',
    visualEditAddBannerHint: '가로 스와이프: 생일, 같은 날짜 세일, 창고 세일, 일반 배너',
    ...
    visualEditAddPromoBanner: '배너 추가',
    ...
    visualEditGridRowsLabel: '줄 수',
    visualEditGridRowsHint: '더 보기는 같은 줄 수만큼 추가합니다.',
    ...
    searchAliasesPanelTitle: "키워드 매핑",
    ...
    listingFacetCacheTitle: "필터 캐시",
    listingFacetCacheHint:
      "사이즈 / 색상 / 스타일 / 가격 필터를 카테고리와 검색어별로 저장합니다. 재고를 고치면 Redis 버전을 올린 뒤 Postgres에 다시 씁니다.",
    listingFacetCacheLoadError: "필터 캐시를 불러오지 못했습니다.",
    listingFacetCacheEmpty: "필터 스냅샷이 아직 없습니다.",
    listingFacetCacheScopeCategory: "카테고리",
    listingFacetCacheScopeSearch: "검색",
    listingFacetCacheCountCategory: "카테고리",
    listingFacetCacheCountSearch: "키워드",
    listingFacetCacheRebuildCategory: "카테고리 재생성",
    listingFacetCacheRebuildSearch: "키워드 재생성",
    listingFacetCacheRebuildAll: "전체 재생성",
    listingFacetCacheRebuildAllConfirm: "필터 캐시를 모두 재생성할까요? 큰 카탈로그에서는 몇 분이 걸릴 수 있습니다.",
    listingFacetCacheRebuildOk: "필터 캐시 {count}개를 재생성했습니다.",
    listingFacetCacheRebuildError: "재생성에 실패했습니다.",
    listingFacetCachePinLabel: "키워드 고정",
    listingFacetCachePinPlaceholder: "예: 꽃무늬 원피스",
    listingFacetCachePin: "고정",
    listingFacetCachePinRequired: "검색 키워드를 입력하세요.",
    listingFacetCachePinOk: "«{keyword}» 필터 캐시를 고정했습니다.",
    listingFacetCachePinError: "키워드를 고정하지 못했습니다.",
    listingFacetCacheFilter: "필터",
    listingFacetCacheFilterAll: "전체",
    listingFacetCacheColScope: "범위",
    listingFacetCacheColLabel: "라벨",
    listingFacetCacheColProducts: "상품",
    listingFacetCacheColFacets: "사이즈/색/스타일",
    listingFacetCacheColPrice: "가격",
    listingFacetCacheColUpdated: "업데이트",
    listingFacetCacheStale: "만료",
    listingFacetCacheDeleteConfirm: "캐시 «{label}»을(를) 삭제할까요?",
    listingFacetCacheDeleteOk: "필터 캐시를 삭제했습니다.",
    listingFacetCacheDeleteError: "캐시를 삭제하지 못했습니다.",
    searchCacheTitle: "검색 캐시와 통계",
    searchCacheHint:
      "고객 계정 기록의 검색어입니다. 카테고리 / 샵 목록 id는 Postgres, 텍스트 검색 JSON은 Redis만 사용합니다 — 삭제하면 재고 버전이 올라갑니다.",
    searchCacheLoadError: "검색 캐시를 불러오지 못했습니다.",
    searchCacheKeywordDays: "일수",
    searchCacheKeywordHint: "이 기간에 갱신된 방문자 프로필의 키워드를 집계합니다.",
    searchCacheColKeyword: "키워드",
    searchCacheColHits: "횟수",
    searchCacheKeywordsEmpty: "검색 키워드가 아직 없습니다.",
    searchCacheIdListTitle: "Id 목록 캐시",
    searchCacheIdListHint: "카테고리 목록과 샵 카탈로그의 Postgres 계층입니다(텍스트 검색 제외).",
    searchCacheIdListEmpty: "Id 목록 캐시가 아직 없습니다.",
    searchCacheClearAll: "전체 삭제",
    searchCacheClearAllConfirm: "목록 id 캐시를 지우고 재고 버전을 올릴까요? 고객은 DB에서 다시 불러옵니다.",
    searchCacheClearOk: "캐시 {count}행을 삭제했습니다.",
    searchCacheClearError: "캐시를 지우지 못했습니다.",
    searchCacheDeleteConfirm: "캐시 «{key}»을(를) 삭제할까요?",
    searchCacheDeleteOk: "캐시 행을 삭제했습니다.",
    searchCacheScopeCategory: "카테고리",
    searchCacheScopeShop: "샵 카탈로그",
    searchCacheColScope: "범위",
    searchCacheColKey: "키",
    searchCacheColProducts: "상품",
    searchCacheColIds: "Id",
    searchCacheColUpdated: "업데이트",
    searchCacheStale: "만료",
    ...
    reviewsAdminEmpty: '아직 리뷰가 없습니다. Import로 Excel을 업로드하세요.',
    ...
    reviewsAdminDownloadSample: 'Excel 샘플 다운로드',
    reviewsAdminImport: 'Import',
    ...
    reviewsAdminPageTitle: '상품 리뷰 관리',
    qaAdminPageTitle: '모든 상품 Q&A',
    reviewsAdminImporting: '가져오는 중...',
    reviewsAdminViewWebsite: '웹사이트 보기',
    reviewsAdminAutosaveHint: '표에서 바로 수정 — 약 0.7초 후 자동 저장됩니다.',
    reviewsAdminDisplayLogicLabel: '표시 로직:',
    reviewsAdminDisplayLogic:
    ...
    reviewsAdminDeleting: '삭제 중...',
    reviewsAdminLoading: '불러오는 중...',
    reviewsAdminColStt: '번호',
    reviewsAdminColType: '유형',
    reviewsAdminColShowAt: '표시 위치',
    reviewsAdminColActions: '기능',
    reviewsAdminColActive: '활성화',
    reviewsAdminColTime: '시간',
    reviewsAdminColReply: '답변',
    reviewsAdminContentCol: '내용',
    reviewsAdminTypeImport: 'Import',
    reviewsAdminTypeCustomer: '고객',
    reviewsAdminShowGroup: '그룹 {n}',
    reviewsAdminShowProduct: '상품 #{id}',
    reviewsAdminActiveShow: '표시',
    reviewsAdminActiveHide: '숨김',
    reviewsAdminViewReview: '리뷰 보기',
    reviewsAdminSaving: '저장 중...',
    reviewsAdminWaitingSave: '저장 대기...',
    reviewsAdminDeleted: '삭제됨',
    reviewsAdminDeleteFailed: '삭제 실패',
    reviewsAdminSaveFailed: '저장 실패',
    reviewsAdminLoadFailed: '목록을 불러오지 못했습니다',
    reviewsAdminDeleteAllConfirmCount: '{n}개의 리뷰를 모두 삭제할까요? 되돌릴 수 없습니다.',
    reviewsAdminDeletedCount: '{n}개 리뷰를 삭제했습니다',
    qaAdminSearchGroupLabel: '질문 그룹으로 검색',
    qaAdminSearchGroupPlaceholder: '그룹 번호 입력...',
    qaAdminAddInTable: '새로 추가(표에서 편집)',
    qaAdminResetColWidths: '열 너비 재설정',
    qaAdminResetColWidthsOk: '열 너비를 재설정했습니다',
    qaAdminShowCount: '표시',
    qaAdminColView: '보기',
    qaAdminColAsker: '질문자 이름',
    qaAdminColAskContent: '질문 내용',
    qaAdminColUsefulCount: '도움됨 수',
    qaAdminColAdminName: '관리자 답변 이름',
    qaAdminColAdminContent: '관리자 답변 내용',
    qaAdminColUserOneName: '사용자 1 이름',
    qaAdminColUserOneContent: '사용자 1 내용',
    qaAdminColUserTwoName: '사용자 2 이름',
    qaAdminColUserTwoContent: '사용자 2 내용',
    qaAdminColStatusDelete: '상태 / 삭제',
    qaAdminColAskedAt: '질문 시각',
    qaAdminColProductId: '상품 ID',
    qaAdminColUpdatedAt: '수정 시각',
    qaAdminColAdminRepliedAt: '관리자 답변 시각',
    qaAdminColUserOneId: '사용자 1 ID',
    qaAdminColUserOneAt: '사용자 1 시각',
    qaAdminColUserTwoId: '사용자 2 ID',
    qaAdminColUserTwoAt: '사용자 2 시각',
    qaAdminColReplyCount: '답변 수',
    qaAdminViewQuestion: '질문 보기',
    qaAdminReplyCountLocked: '{n} (2=잠금)',
    qaAdminResizeCol: '끌어 열 너비 변경',
    qaAdminDelete: '삭제',
    ...
    resetWebsiteSuccess: '리셋했습니다. 이전 웹은 7일간 저장됩니다. 미리보기 막대의 「리셋한 웹 복구하기」로 되돌리세요.',
    restoreResetTrashButton: '리셋한 웹 복구하기',
    restoreResetTrashHint: '리셋 전 웹이 약 {days}일 남아 있습니다. 새 웹이 있어도 복구할 수 있습니다.',
