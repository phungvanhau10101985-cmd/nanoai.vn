...
const TOOL_IMAGE_BY_HREF: Record<string, string> = {
  ...
  '/?hubStudio=packaging_kit': 'https://nanoai.b-cdn.net/results/ef34291c-0b83-49c1-b390-4ab50df32e9d/sticker_1776514062010.png',
...
const FRIENDLY_FEATURE_TITLE_BY_HREF: Record<string, string> = {
  ...
  '/?hubStudio=packaging_kit': 'Thiết kế bao bì',
