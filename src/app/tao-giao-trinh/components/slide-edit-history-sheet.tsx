...
import { getSlideEditHistory, restoreSharedFromHistory } from '../actions'
...
export function SlideEditHistorySheet({ open, onOpenChange, curriculumId, tr, onRestored }: SlideEditHistorySheetProps) {
  ...
  const handleRestore = async (historyId: string) => {
    ...
    try {
      const res = await restoreSharedFromHistory(curriculumId, historyId)
      if (res?.success) {
        onRestored?.()
        onOpenChange(false)
      } else {
