...
import SuaAnhTheoYeuCauClientPage from './sua-anh-theo-yeu-cau-client-page'
...
const seo = getFeatureSeo('sua-anh-theo-yeu-cau')
...
export default async function SuaAnhTheoYeuCauPage() {
