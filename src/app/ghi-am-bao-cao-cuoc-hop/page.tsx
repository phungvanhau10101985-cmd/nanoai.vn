...
const GhiAmBaoCaoCuocHopClientPage = dynamic(() => import('./ghi-am-bao-cao-cuoc-hop-client-page'), {
  ssr: false,
})

const seo = getFeatureSeo('ghi-am-bao-cao-cuoc-hop')
...
export default async function GhiAmBaoCaoCuocHopPage() {
