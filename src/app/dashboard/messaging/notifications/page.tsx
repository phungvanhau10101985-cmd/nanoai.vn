...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const n = t.partnerMessagingNotifications
...
export default async function DashboardMessagingNotificationsPage({
  searchParams,
}: {
  ...
  redirect(messagingSettingsSectionHref('hub-notifications', partner))
}
