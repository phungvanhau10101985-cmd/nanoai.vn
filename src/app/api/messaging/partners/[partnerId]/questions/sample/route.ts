...
import { buildQuestionImportSampleXlsx } from '@/lib/partner-website/reviews/partner-reviews-qa-excel'
...
export async function GET(_req: Request, ctx: { params: Promise<{ partnerId: string }> }) {
  ...
  return new NextResponse(new Uint8Array(buf), {
    ...
    headers: {
      ...
      'Content-Disposition': 'attachment; filename="cau_hoi_san_pham_mau.xlsx"',
    },
  })
}
