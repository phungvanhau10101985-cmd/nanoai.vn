...
function main() {
  ...
  expectAfterSales('Mua phải cọc tiền à?', false)
  expectAfterSales('đang hỏi là có phải đặt cọc trước không', false)
  expectAfterSales('Nếu như theo shop gửi cỡ bao lâu e mới nhận đc hàng', false)
