-- Trần ANN kho = 68 (align PARTNER_PUBLIC_INVENTORY_SEARCH_MAX = 68). Ghi đè migration 70 nếu đã chạy.
...
as $$
  ...
  limit greatest(1, least(coalesce(p_limit, 8), 68));
$$;
...
as $$
  ...
  limit greatest(1, least(coalesce(p_limit, 24), 68));
$$;
